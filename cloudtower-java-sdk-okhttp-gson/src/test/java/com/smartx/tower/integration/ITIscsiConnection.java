...
public class ITIscsiConnection extends IT {
  ...
  public void getIscsiConnections(String payload) {
    try {
      ...
      GetIscsiConnectionsRequestBody params = gson.fromJson(payload, GetIscsiConnectionsRequestBody.class);
      // do some modify to params(optional)
      List<IscsiConnection> result = api.getIscsiConnections("zh-CN", params);
