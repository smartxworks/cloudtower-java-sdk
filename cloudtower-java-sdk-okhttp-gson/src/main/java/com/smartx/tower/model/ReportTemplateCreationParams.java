...
public class ReportTemplateCreationParams {
  ...
  private List<ReportTemplateCreationParamsResourceMeta> resourceMeta = new ArrayList<ReportTemplateCreationParamsResourceMeta>();

  public static final String SERIALIZED_NAME_EXECUTE_PLAN = "execute_plan";
  @SerializedName(SERIALIZED_NAME_EXECUTE_PLAN)
  private List<ReportTemplateCreationParamsExecutePlan> executePlan = new ArrayList<ReportTemplateCreationParamsExecutePlan>();
