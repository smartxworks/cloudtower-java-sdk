...
public class NestedFrozenDisks {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(boot, bus, disabled, diskName, elfImageLocalId, imageName, index, key, maxBandwidth, maxBandwidthPolicy, maxIops, maxIopsPolicy, path, size, snapshotLocalId, storagePolicyUuid, svtImageLocalId, type, vmVolumeLocalId);
  }
