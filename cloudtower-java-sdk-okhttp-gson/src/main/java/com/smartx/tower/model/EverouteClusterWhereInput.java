...
public class EverouteClusterWhereInput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentElfClustersEvery, agentElfClustersNone, agentElfClustersSome, agentElfVdsesEvery, agentElfVdsesNone, agentElfVdsesSome, AND, globalDefaultAction, globalDefaultActionIn, globalDefaultActionNot, globalDefaultActionNotIn, id, idContains, idEndsWith, idGt, idGte, idIn, idLt, idLte, idNot, idNotContains, idNotEndsWith, idNotIn, idNotStartsWith, idStartsWith, name, nameContains, nameEndsWith, nameGt, nameGte, nameIn, nameLt, nameLte, nameNot, nameNotContains, nameNotEndsWith, nameNotIn, nameNotStartsWith, nameStartsWith, NOT, OR, phase, phaseIn, phaseNot, phaseNotIn, version, versionContains, versionEndsWith, versionGt, versionGte, versionIn, versionLt, versionLte, versionNot, versionNotContains, versionNotEndsWith, versionNotIn, versionNotStartsWith, versionStartsWith);
  }
