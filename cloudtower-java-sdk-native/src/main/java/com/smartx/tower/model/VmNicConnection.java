 ...
 */
@JsonPropertyOrder({
  VmNicConnection.JSON_PROPERTY_AGGREGATE
})
...
public class VmNicConnection {
  ...
  public VmNicConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this VmNicConnection object is equal to o.
   */
  @Override
