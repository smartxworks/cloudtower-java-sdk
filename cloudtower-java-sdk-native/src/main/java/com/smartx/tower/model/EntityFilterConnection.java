 ...
 */
@JsonPropertyOrder({
  EntityFilterConnection.JSON_PROPERTY_AGGREGATE
})
...
public class EntityFilterConnection {
  ...
  public EntityFilterConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this EntityFilterConnection object is equal to o.
   */
  @Override
