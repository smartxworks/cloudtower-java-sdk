 ...
 */
@JsonPropertyOrder({
  ClusterImage.JSON_PROPERTY_CLUSTER,
  ClusterImage.JSON_PROPERTY_ENTITY_ASYNC_STATUS,
  ClusterImage.JSON_PROPERTY_ID,
  ClusterImage.JSON_PROPERTY_META_NAME,
  ClusterImage.JSON_PROPERTY_META_SIZE,
  ClusterImage.JSON_PROPERTY_NAME,
  ClusterImage.JSON_PROPERTY_SIZE,
  ClusterImage.JSON_PROPERTY_VERSION
})
...
public class ClusterImage {
  ...
  **/
  ...
  /**
   * Return true if this ClusterImage object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cluster, clusterImage.cluster) &&
        equalsNullable(this.entityAsyncStatus, clusterImage.entityAsyncStatus) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cluster, hashCodeNullable(entityAsyncStatus), id, metaName, metaSize, name, size, version);
  }
