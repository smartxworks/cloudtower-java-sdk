 ...
 */
@JsonPropertyOrder({
  ClusterImageConnection.JSON_PROPERTY_AGGREGATE
})
...
public class ClusterImageConnection {
  ...
  public ClusterImageConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this ClusterImageConnection object is equal to o.
   */
  @Override
