 ...
 */
@JsonPropertyOrder({
  DatacenterConnection.JSON_PROPERTY_AGGREGATE
})
...
public class DatacenterConnection {
  ...
  public DatacenterConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this DatacenterConnection object is equal to o.
   */
  @Override
