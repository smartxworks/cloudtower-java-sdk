 ...
 */
@JsonPropertyOrder({
  ViewConnection.JSON_PROPERTY_AGGREGATE
})
...
public class ViewConnection {
  ...
  public ViewConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this ViewConnection object is equal to o.
   */
  @Override
