 ...
 */
@JsonPropertyOrder({
  NodeTopoConnection.JSON_PROPERTY_AGGREGATE
})
...
public class NodeTopoConnection {
  ...
  public NodeTopoConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this NodeTopoConnection object is equal to o.
   */
  @Override
