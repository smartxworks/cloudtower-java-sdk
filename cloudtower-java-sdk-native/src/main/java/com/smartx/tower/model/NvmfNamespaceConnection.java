 ...
 */
@JsonPropertyOrder({
  NvmfNamespaceConnection.JSON_PROPERTY_AGGREGATE
})
...
public class NvmfNamespaceConnection {
  ...
  public NvmfNamespaceConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this NvmfNamespaceConnection object is equal to o.
   */
  @Override
