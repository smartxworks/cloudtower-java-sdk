 ...
 */
@JsonPropertyOrder({
  DeployConnection.JSON_PROPERTY_AGGREGATE
})
...
public class DeployConnection {
  ...
  public DeployConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this DeployConnection object is equal to o.
   */
  @Override
