 ...
 */
@JsonPropertyOrder({
  TaskConnection.JSON_PROPERTY_AGGREGATE
})
...
public class TaskConnection {
  ...
  public TaskConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this TaskConnection object is equal to o.
   */
  @Override
