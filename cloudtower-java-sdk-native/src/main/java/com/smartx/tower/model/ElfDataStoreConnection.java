 ...
 */
@JsonPropertyOrder({
  ElfDataStoreConnection.JSON_PROPERTY_AGGREGATE
})
...
public class ElfDataStoreConnection {
  ...
  public ElfDataStoreConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this ElfDataStoreConnection object is equal to o.
   */
  @Override
