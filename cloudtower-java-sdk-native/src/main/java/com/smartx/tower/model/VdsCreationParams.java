 ...
 */
@JsonPropertyOrder({
  VdsCreationParams.JSON_PROPERTY_NIC_IDS,
  VdsCreationParams.JSON_PROPERTY_CLUSTER_ID,
  VdsCreationParams.JSON_PROPERTY_BOND_MODE,
  VdsCreationParams.JSON_PROPERTY_NAME
})
...
public class VdsCreationParams {
  ...
  **/
  ...
  /**
   * Return true if this VdsCreationParams object is equal to o.
   */
  @Override
