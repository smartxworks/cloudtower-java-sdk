 ...
 */
@JsonPropertyOrder({
  VdsConnection.JSON_PROPERTY_AGGREGATE
})
...
public class VdsConnection {
  ...
  public VdsConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this VdsConnection object is equal to o.
   */
  @Override
