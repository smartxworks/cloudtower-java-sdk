 ...
 */
@JsonPropertyOrder({
  HostCreationParamsData.JSON_PROPERTY_IFACES,
  HostCreationParamsData.JSON_PROPERTY_DISKS,
  HostCreationParamsData.JSON_PROPERTY_PLATFORM_PASSWORD,
  HostCreationParamsData.JSON_PROPERTY_PLATFORM_USERNAME,
  HostCreationParamsData.JSON_PROPERTY_PLATFORM_IP,
  HostCreationParamsData.JSON_PROPERTY_IPMI,
  HostCreationParamsData.JSON_PROPERTY_HOSTNAME,
  HostCreationParamsData.JSON_PROPERTY_HOST_UUID,
  HostCreationParamsData.JSON_PROPERTY_HOST_IP
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-10-27T15:59:14.939791800+08:00[Asia/Shanghai]")
public class HostCreationParamsData {
  public static final String JSON_PROPERTY_IFACES = "ifaces";
  private List<HostBatchCreateIfaceInput> ifaces = new ArrayList<>();

  public static final String JSON_PROPERTY_DISKS = "disks";
  private List<HostBatchCreateDiskInput> disks = new ArrayList<>();

  public static final String JSON_PROPERTY_PLATFORM_PASSWORD = "platform_password";
  private String platformPassword;

  public static final String JSON_PROPERTY_PLATFORM_USERNAME = "platform_username";
  private String platformUsername;

  public static final String JSON_PROPERTY_PLATFORM_IP = "platform_ip";
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_PLATFORM_PASSWORD)
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_PLATFORM_USERNAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_PLATFORM_IP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  ...
  /**
   * Return true if this HostCreationParams_data object is equal to o.
   */
  @Override
