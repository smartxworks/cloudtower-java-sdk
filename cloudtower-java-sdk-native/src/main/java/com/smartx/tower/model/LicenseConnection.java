 ...
 */
@JsonPropertyOrder({
  LicenseConnection.JSON_PROPERTY_AGGREGATE
})
...
public class LicenseConnection {
  ...
  public LicenseConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this LicenseConnection object is equal to o.
   */
  @Override
