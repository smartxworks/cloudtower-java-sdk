 ...
 */
@JsonPropertyOrder({
  SecurityPolicyConnection.JSON_PROPERTY_AGGREGATE
})
...
public class SecurityPolicyConnection {
  ...
  public SecurityPolicyConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this SecurityPolicyConnection object is equal to o.
   */
  @Override
