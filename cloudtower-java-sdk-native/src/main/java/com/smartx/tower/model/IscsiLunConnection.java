 ...
 */
@JsonPropertyOrder({
  IscsiLunConnection.JSON_PROPERTY_AGGREGATE
})
...
public class IscsiLunConnection {
  ...
  public IscsiLunConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this IscsiLunConnection object is equal to o.
   */
  @Override
