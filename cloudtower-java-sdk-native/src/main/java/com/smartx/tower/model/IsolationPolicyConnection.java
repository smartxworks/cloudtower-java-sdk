 ...
 */
@JsonPropertyOrder({
  IsolationPolicyConnection.JSON_PROPERTY_AGGREGATE
})
...
public class IsolationPolicyConnection {
  ...
  public IsolationPolicyConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this IsolationPolicyConnection object is equal to o.
   */
  @Override
