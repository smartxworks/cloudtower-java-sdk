 ...
 */
@JsonPropertyOrder({
  VcenterAccountConnection.JSON_PROPERTY_AGGREGATE
})
...
public class VcenterAccountConnection {
  ...
  public VcenterAccountConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this VcenterAccountConnection object is equal to o.
   */
  @Override
