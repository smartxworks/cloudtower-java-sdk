 ...
 */
@JsonPropertyOrder({
  GetVmTemplatesConnectionRequestBody.JSON_PROPERTY_AFTER,
  GetVmTemplatesConnectionRequestBody.JSON_PROPERTY_BEFORE,
  GetVmTemplatesConnectionRequestBody.JSON_PROPERTY_FIRST,
  GetVmTemplatesConnectionRequestBody.JSON_PROPERTY_LAST,
  GetVmTemplatesConnectionRequestBody.JSON_PROPERTY_ORDER_BY,
  GetVmTemplatesConnectionRequestBody.JSON_PROPERTY_SKIP,
  GetVmTemplatesConnectionRequestBody.JSON_PROPERTY_WHERE
})
...
public class GetVmTemplatesConnectionRequestBody {
  ...
  private JsonNullable<VmTemplateOrderByInput> orderBy = JsonNullable.<VmTemplateOrderByInput>undefined();
  ...
  private JsonNullable<VmTemplateWhereInput> where = JsonNullable.<VmTemplateWhereInput>undefined();
  ...
  **/
  ...
  public GetVmTemplatesConnectionRequestBody first(Double first) {
  ...
  **/
  ...
  public GetVmTemplatesConnectionRequestBody last(Double last) {
  ...
  **/
  ...
  public GetVmTemplatesConnectionRequestBody orderBy(VmTemplateOrderByInput orderBy) {
    this.orderBy = JsonNullable.<VmTemplateOrderByInput>of(orderBy);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<VmTemplateOrderByInput> getOrderBy_JsonNullable() {
    return orderBy;
  }
  
  @JsonProperty(JSON_PROPERTY_ORDER_BY)
  public void setOrderBy_JsonNullable(JsonNullable<VmTemplateOrderByInput> orderBy) {
  ...
  public GetVmTemplatesConnectionRequestBody skip(Double skip) {
  ...
  **/
  ...
  public GetVmTemplatesConnectionRequestBody where(VmTemplateWhereInput where) {
    this.where = JsonNullable.<VmTemplateWhereInput>of(where);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<VmTemplateWhereInput> getWhere_JsonNullable() {
    return where;
  }
  
  @JsonProperty(JSON_PROPERTY_WHERE)
  public void setWhere_JsonNullable(JsonNullable<VmTemplateWhereInput> where) {
    this.where = where;
  }
  ...
  /**
   * Return true if this GetVmTemplatesConnectionRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.after, getVmTemplatesConnectionRequestBody.after) &&
        equalsNullable(this.before, getVmTemplatesConnectionRequestBody.before) &&
        equalsNullable(this.first, getVmTemplatesConnectionRequestBody.first) &&
        equalsNullable(this.last, getVmTemplatesConnectionRequestBody.last) &&
        equalsNullable(this.orderBy, getVmTemplatesConnectionRequestBody.orderBy) &&
        equalsNullable(this.skip, getVmTemplatesConnectionRequestBody.skip) &&
        equalsNullable(this.where, getVmTemplatesConnectionRequestBody.where);
  }
