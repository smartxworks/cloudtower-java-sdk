 ...
 */
@JsonPropertyOrder({
  VmPlacementGroupConnection.JSON_PROPERTY_AGGREGATE
})
...
public class VmPlacementGroupConnection {
  ...
  public VmPlacementGroupConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this VmPlacementGroupConnection object is equal to o.
   */
  @Override
