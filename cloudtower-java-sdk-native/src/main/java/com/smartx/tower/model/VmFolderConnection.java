 ...
 */
@JsonPropertyOrder({
  VmFolderConnection.JSON_PROPERTY_AGGREGATE
})
...
public class VmFolderConnection {
  ...
  public VmFolderConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this VmFolderConnection object is equal to o.
   */
  @Override
