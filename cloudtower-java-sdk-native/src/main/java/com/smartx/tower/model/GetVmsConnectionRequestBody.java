 ...
 */
@JsonPropertyOrder({
  GetVmsConnectionRequestBody.JSON_PROPERTY_AFTER,
  GetVmsConnectionRequestBody.JSON_PROPERTY_BEFORE,
  GetVmsConnectionRequestBody.JSON_PROPERTY_FIRST,
  GetVmsConnectionRequestBody.JSON_PROPERTY_LAST,
  GetVmsConnectionRequestBody.JSON_PROPERTY_ORDER_BY,
  GetVmsConnectionRequestBody.JSON_PROPERTY_SKIP,
  GetVmsConnectionRequestBody.JSON_PROPERTY_WHERE
})
...
public class GetVmsConnectionRequestBody {
  ...
  private JsonNullable<VmOrderByInput> orderBy = JsonNullable.<VmOrderByInput>undefined();
  ...
  private JsonNullable<VmWhereInput> where = JsonNullable.<VmWhereInput>undefined();
  ...
  **/
  ...
  public GetVmsConnectionRequestBody first(Double first) {
  ...
  **/
  ...
  public GetVmsConnectionRequestBody last(Double last) {
  ...
  **/
  ...
  public GetVmsConnectionRequestBody orderBy(VmOrderByInput orderBy) {
    this.orderBy = JsonNullable.<VmOrderByInput>of(orderBy);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<VmOrderByInput> getOrderBy_JsonNullable() {
    return orderBy;
  }
  
  @JsonProperty(JSON_PROPERTY_ORDER_BY)
  public void setOrderBy_JsonNullable(JsonNullable<VmOrderByInput> orderBy) {
  ...
  public GetVmsConnectionRequestBody skip(Double skip) {
  ...
  **/
  ...
  public GetVmsConnectionRequestBody where(VmWhereInput where) {
    this.where = JsonNullable.<VmWhereInput>of(where);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<VmWhereInput> getWhere_JsonNullable() {
    return where;
  }
  
  @JsonProperty(JSON_PROPERTY_WHERE)
  public void setWhere_JsonNullable(JsonNullable<VmWhereInput> where) {
    this.where = where;
  }
  ...
  /**
   * Return true if this GetVmsConnectionRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.after, getVmsConnectionRequestBody.after) &&
        equalsNullable(this.before, getVmsConnectionRequestBody.before) &&
        equalsNullable(this.first, getVmsConnectionRequestBody.first) &&
        equalsNullable(this.last, getVmsConnectionRequestBody.last) &&
        equalsNullable(this.orderBy, getVmsConnectionRequestBody.orderBy) &&
        equalsNullable(this.skip, getVmsConnectionRequestBody.skip) &&
        equalsNullable(this.where, getVmsConnectionRequestBody.where);
  }
