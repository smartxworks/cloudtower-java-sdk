 ...
 */
@JsonPropertyOrder({
  AlertConnection.JSON_PROPERTY_AGGREGATE
})
...
public class AlertConnection {
  ...
  public AlertConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this AlertConnection object is equal to o.
   */
  @Override
