 ...
 */
@JsonPropertyOrder({
  VmTemplateConnection.JSON_PROPERTY_AGGREGATE
})
...
public class VmTemplateConnection {
  ...
  public VmTemplateConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this VmTemplateConnection object is equal to o.
   */
  @Override
