 ...
 */
@JsonPropertyOrder({
  ClusterTopoConnection.JSON_PROPERTY_AGGREGATE
})
...
public class ClusterTopoConnection {
  ...
  public ClusterTopoConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this ClusterTopoConnection object is equal to o.
   */
  @Override
