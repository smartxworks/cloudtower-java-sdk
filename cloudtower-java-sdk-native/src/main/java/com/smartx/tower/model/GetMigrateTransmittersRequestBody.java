 ...
 */
@JsonPropertyOrder({
  GetMigrateTransmittersRequestBody.JSON_PROPERTY_AFTER,
  GetMigrateTransmittersRequestBody.JSON_PROPERTY_BEFORE,
  GetMigrateTransmittersRequestBody.JSON_PROPERTY_FIRST,
  GetMigrateTransmittersRequestBody.JSON_PROPERTY_LAST,
  GetMigrateTransmittersRequestBody.JSON_PROPERTY_ORDER_BY,
  GetMigrateTransmittersRequestBody.JSON_PROPERTY_SKIP,
  GetMigrateTransmittersRequestBody.JSON_PROPERTY_WHERE
})
...
public class GetMigrateTransmittersRequestBody {
  ...
  **/
  ...
  /**
   * Return true if this GetMigrateTransmittersRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.after, getMigrateTransmittersRequestBody.after) &&
        equalsNullable(this.before, getMigrateTransmittersRequestBody.before) &&
        equalsNullable(this.first, getMigrateTransmittersRequestBody.first) &&
        equalsNullable(this.last, getMigrateTransmittersRequestBody.last) &&
        equalsNullable(this.orderBy, getMigrateTransmittersRequestBody.orderBy) &&
        equalsNullable(this.skip, getMigrateTransmittersRequestBody.skip) &&
        equalsNullable(this.where, getMigrateTransmittersRequestBody.where);
  }
