 ...
 */
@JsonPropertyOrder({
  VmVolumeConnection.JSON_PROPERTY_AGGREGATE
})
...
public class VmVolumeConnection {
  ...
  public VmVolumeConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this VmVolumeConnection object is equal to o.
   */
  @Override
