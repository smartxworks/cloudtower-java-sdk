 ...
 */
@JsonPropertyOrder({
  LabelConnection.JSON_PROPERTY_AGGREGATE
})
...
public class LabelConnection {
  ...
  public LabelConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this LabelConnection object is equal to o.
   */
  @Override
