 ...
 */
@JsonPropertyOrder({
  GlobalAlertRuleConnection.JSON_PROPERTY_AGGREGATE
})
...
public class GlobalAlertRuleConnection {
  ...
  public GlobalAlertRuleConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this GlobalAlertRuleConnection object is equal to o.
   */
  @Override
