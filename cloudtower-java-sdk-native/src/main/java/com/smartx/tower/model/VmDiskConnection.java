 ...
 */
@JsonPropertyOrder({
  VmDiskConnection.JSON_PROPERTY_AGGREGATE
})
...
public class VmDiskConnection {
  ...
  public VmDiskConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this VmDiskConnection object is equal to o.
   */
  @Override
