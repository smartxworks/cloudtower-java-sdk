 ...
 */
@JsonPropertyOrder({
  OrganizationConnection.JSON_PROPERTY_AGGREGATE
})
...
public class OrganizationConnection {
  ...
  public OrganizationConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this OrganizationConnection object is equal to o.
   */
  @Override
