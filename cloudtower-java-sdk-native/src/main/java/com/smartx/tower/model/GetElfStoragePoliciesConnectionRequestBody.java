 ...
 */
@JsonPropertyOrder({
  GetElfStoragePoliciesConnectionRequestBody.JSON_PROPERTY_AFTER,
  GetElfStoragePoliciesConnectionRequestBody.JSON_PROPERTY_BEFORE,
  GetElfStoragePoliciesConnectionRequestBody.JSON_PROPERTY_FIRST,
  GetElfStoragePoliciesConnectionRequestBody.JSON_PROPERTY_LAST,
  GetElfStoragePoliciesConnectionRequestBody.JSON_PROPERTY_ORDER_BY,
  GetElfStoragePoliciesConnectionRequestBody.JSON_PROPERTY_SKIP,
  GetElfStoragePoliciesConnectionRequestBody.JSON_PROPERTY_WHERE
})
...
public class GetElfStoragePoliciesConnectionRequestBody {
  ...
  private JsonNullable<ElfStoragePolicyOrderByInput> orderBy = JsonNullable.<ElfStoragePolicyOrderByInput>undefined();
  ...
  private JsonNullable<ElfStoragePolicyWhereInput> where = JsonNullable.<ElfStoragePolicyWhereInput>undefined();
  ...
  **/
  ...
  public GetElfStoragePoliciesConnectionRequestBody first(Double first) {
  ...
  **/
  ...
  public GetElfStoragePoliciesConnectionRequestBody last(Double last) {
  ...
  **/
  ...
  public GetElfStoragePoliciesConnectionRequestBody orderBy(ElfStoragePolicyOrderByInput orderBy) {
    this.orderBy = JsonNullable.<ElfStoragePolicyOrderByInput>of(orderBy);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<ElfStoragePolicyOrderByInput> getOrderBy_JsonNullable() {
    return orderBy;
  }
  
  @JsonProperty(JSON_PROPERTY_ORDER_BY)
  public void setOrderBy_JsonNullable(JsonNullable<ElfStoragePolicyOrderByInput> orderBy) {
  ...
  public GetElfStoragePoliciesConnectionRequestBody skip(Double skip) {
  ...
  **/
  ...
  public GetElfStoragePoliciesConnectionRequestBody where(ElfStoragePolicyWhereInput where) {
    this.where = JsonNullable.<ElfStoragePolicyWhereInput>of(where);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<ElfStoragePolicyWhereInput> getWhere_JsonNullable() {
    return where;
  }
  
  @JsonProperty(JSON_PROPERTY_WHERE)
  public void setWhere_JsonNullable(JsonNullable<ElfStoragePolicyWhereInput> where) {
    this.where = where;
  }
  ...
  /**
   * Return true if this GetElfStoragePoliciesConnectionRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.after, getElfStoragePoliciesConnectionRequestBody.after) &&
        equalsNullable(this.before, getElfStoragePoliciesConnectionRequestBody.before) &&
        equalsNullable(this.first, getElfStoragePoliciesConnectionRequestBody.first) &&
        equalsNullable(this.last, getElfStoragePoliciesConnectionRequestBody.last) &&
        equalsNullable(this.orderBy, getElfStoragePoliciesConnectionRequestBody.orderBy) &&
        equalsNullable(this.skip, getElfStoragePoliciesConnectionRequestBody.skip) &&
        equalsNullable(this.where, getElfStoragePoliciesConnectionRequestBody.where);
  }
