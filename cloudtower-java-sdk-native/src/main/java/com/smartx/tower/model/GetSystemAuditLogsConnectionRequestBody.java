 ...
 */
@JsonPropertyOrder({
  GetSystemAuditLogsConnectionRequestBody.JSON_PROPERTY_AFTER,
  GetSystemAuditLogsConnectionRequestBody.JSON_PROPERTY_BEFORE,
  GetSystemAuditLogsConnectionRequestBody.JSON_PROPERTY_FIRST,
  GetSystemAuditLogsConnectionRequestBody.JSON_PROPERTY_LAST,
  GetSystemAuditLogsConnectionRequestBody.JSON_PROPERTY_ORDER_BY,
  GetSystemAuditLogsConnectionRequestBody.JSON_PROPERTY_SKIP,
  GetSystemAuditLogsConnectionRequestBody.JSON_PROPERTY_WHERE
})
...
public class GetSystemAuditLogsConnectionRequestBody {
  ...
  private JsonNullable<SystemAuditLogOrderByInput> orderBy = JsonNullable.<SystemAuditLogOrderByInput>undefined();
  ...
  private JsonNullable<SystemAuditLogWhereInput> where = JsonNullable.<SystemAuditLogWhereInput>undefined();
  ...
  **/
  ...
  public GetSystemAuditLogsConnectionRequestBody first(Double first) {
  ...
  **/
  ...
  public GetSystemAuditLogsConnectionRequestBody last(Double last) {
  ...
  **/
  ...
  public GetSystemAuditLogsConnectionRequestBody orderBy(SystemAuditLogOrderByInput orderBy) {
    this.orderBy = JsonNullable.<SystemAuditLogOrderByInput>of(orderBy);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<SystemAuditLogOrderByInput> getOrderBy_JsonNullable() {
    return orderBy;
  }
  
  @JsonProperty(JSON_PROPERTY_ORDER_BY)
  public void setOrderBy_JsonNullable(JsonNullable<SystemAuditLogOrderByInput> orderBy) {
  ...
  public GetSystemAuditLogsConnectionRequestBody skip(Double skip) {
  ...
  **/
  ...
  public GetSystemAuditLogsConnectionRequestBody where(SystemAuditLogWhereInput where) {
    this.where = JsonNullable.<SystemAuditLogWhereInput>of(where);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<SystemAuditLogWhereInput> getWhere_JsonNullable() {
    return where;
  }
  
  @JsonProperty(JSON_PROPERTY_WHERE)
  public void setWhere_JsonNullable(JsonNullable<SystemAuditLogWhereInput> where) {
    this.where = where;
  }
  ...
  /**
   * Return true if this GetSystemAuditLogsConnectionRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.after, getSystemAuditLogsConnectionRequestBody.after) &&
        equalsNullable(this.before, getSystemAuditLogsConnectionRequestBody.before) &&
        equalsNullable(this.first, getSystemAuditLogsConnectionRequestBody.first) &&
        equalsNullable(this.last, getSystemAuditLogsConnectionRequestBody.last) &&
        equalsNullable(this.orderBy, getSystemAuditLogsConnectionRequestBody.orderBy) &&
        equalsNullable(this.skip, getSystemAuditLogsConnectionRequestBody.skip) &&
        equalsNullable(this.where, getSystemAuditLogsConnectionRequestBody.where);
  }
