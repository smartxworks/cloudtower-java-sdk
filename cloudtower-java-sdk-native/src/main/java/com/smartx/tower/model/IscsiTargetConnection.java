 ...
 */
@JsonPropertyOrder({
  IscsiTargetConnection.JSON_PROPERTY_AGGREGATE
})
...
public class IscsiTargetConnection {
  ...
  public IscsiTargetConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this IscsiTargetConnection object is equal to o.
   */
  @Override
