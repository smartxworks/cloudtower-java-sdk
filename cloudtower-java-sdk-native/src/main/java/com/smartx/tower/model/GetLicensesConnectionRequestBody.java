 ...
 */
@JsonPropertyOrder({
  GetLicensesConnectionRequestBody.JSON_PROPERTY_AFTER,
  GetLicensesConnectionRequestBody.JSON_PROPERTY_BEFORE,
  GetLicensesConnectionRequestBody.JSON_PROPERTY_FIRST,
  GetLicensesConnectionRequestBody.JSON_PROPERTY_LAST,
  GetLicensesConnectionRequestBody.JSON_PROPERTY_ORDER_BY,
  GetLicensesConnectionRequestBody.JSON_PROPERTY_SKIP,
  GetLicensesConnectionRequestBody.JSON_PROPERTY_WHERE
})
...
public class GetLicensesConnectionRequestBody {
  ...
  private JsonNullable<LicenseOrderByInput> orderBy = JsonNullable.<LicenseOrderByInput>undefined();
  ...
  private JsonNullable<LicenseWhereInput> where = JsonNullable.<LicenseWhereInput>undefined();
  ...
  **/
  ...
  public GetLicensesConnectionRequestBody first(Double first) {
  ...
  **/
  ...
  public GetLicensesConnectionRequestBody last(Double last) {
  ...
  **/
  ...
  public GetLicensesConnectionRequestBody orderBy(LicenseOrderByInput orderBy) {
    this.orderBy = JsonNullable.<LicenseOrderByInput>of(orderBy);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<LicenseOrderByInput> getOrderBy_JsonNullable() {
    return orderBy;
  }
  
  @JsonProperty(JSON_PROPERTY_ORDER_BY)
  public void setOrderBy_JsonNullable(JsonNullable<LicenseOrderByInput> orderBy) {
  ...
  public GetLicensesConnectionRequestBody skip(Double skip) {
  ...
  **/
  ...
  public GetLicensesConnectionRequestBody where(LicenseWhereInput where) {
    this.where = JsonNullable.<LicenseWhereInput>of(where);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<LicenseWhereInput> getWhere_JsonNullable() {
    return where;
  }
  
  @JsonProperty(JSON_PROPERTY_WHERE)
  public void setWhere_JsonNullable(JsonNullable<LicenseWhereInput> where) {
    this.where = where;
  }
  ...
  /**
   * Return true if this GetLicensesConnectionRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.after, getLicensesConnectionRequestBody.after) &&
        equalsNullable(this.before, getLicensesConnectionRequestBody.before) &&
        equalsNullable(this.first, getLicensesConnectionRequestBody.first) &&
        equalsNullable(this.last, getLicensesConnectionRequestBody.last) &&
        equalsNullable(this.orderBy, getLicensesConnectionRequestBody.orderBy) &&
        equalsNullable(this.skip, getLicensesConnectionRequestBody.skip) &&
        equalsNullable(this.where, getLicensesConnectionRequestBody.where);
  }
