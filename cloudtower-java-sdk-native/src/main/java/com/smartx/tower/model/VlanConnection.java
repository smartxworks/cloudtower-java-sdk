 ...
 */
@JsonPropertyOrder({
  VlanConnection.JSON_PROPERTY_AGGREGATE
})
...
public class VlanConnection {
  ...
  public VlanConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this VlanConnection object is equal to o.
   */
  @Override
