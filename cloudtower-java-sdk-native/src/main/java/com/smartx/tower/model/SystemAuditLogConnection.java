 ...
 */
@JsonPropertyOrder({
  SystemAuditLogConnection.JSON_PROPERTY_AGGREGATE
})
...
public class SystemAuditLogConnection {
  ...
  public SystemAuditLogConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this SystemAuditLogConnection object is equal to o.
   */
  @Override
