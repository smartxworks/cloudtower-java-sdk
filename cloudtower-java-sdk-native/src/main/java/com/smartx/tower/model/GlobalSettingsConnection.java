 ...
 */
@JsonPropertyOrder({
  GlobalSettingsConnection.JSON_PROPERTY_AGGREGATE
})
...
public class GlobalSettingsConnection {
  ...
  public GlobalSettingsConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this GlobalSettingsConnection object is equal to o.
   */
  @Override
