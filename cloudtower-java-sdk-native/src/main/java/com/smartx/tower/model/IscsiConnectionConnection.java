 ...
 */
@JsonPropertyOrder({
  IscsiConnectionConnection.JSON_PROPERTY_AGGREGATE
})
...
public class IscsiConnectionConnection {
  ...
  public IscsiConnectionConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this IscsiConnectionConnection object is equal to o.
   */
  @Override
