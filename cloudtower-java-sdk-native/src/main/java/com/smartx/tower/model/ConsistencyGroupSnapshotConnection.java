 ...
 */
@JsonPropertyOrder({
  ConsistencyGroupSnapshotConnection.JSON_PROPERTY_AGGREGATE
})
...
public class ConsistencyGroupSnapshotConnection {
  ...
  public ConsistencyGroupSnapshotConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this ConsistencyGroupSnapshotConnection object is equal to o.
   */
  @Override
