 ...
 */
@JsonPropertyOrder({
  DiskConnection.JSON_PROPERTY_AGGREGATE
})
...
public class DiskConnection {
  ...
  public DiskConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this DiskConnection object is equal to o.
   */
  @Override
