 ...
 */
@JsonPropertyOrder({
  VmEntityFilterResultConnection.JSON_PROPERTY_AGGREGATE
})
...
public class VmEntityFilterResultConnection {
  ...
  public VmEntityFilterResultConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this VmEntityFilterResultConnection object is equal to o.
   */
  @Override
