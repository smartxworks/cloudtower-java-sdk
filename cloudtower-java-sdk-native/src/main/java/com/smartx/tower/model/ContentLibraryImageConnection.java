 ...
 */
@JsonPropertyOrder({
  ContentLibraryImageConnection.JSON_PROPERTY_AGGREGATE
})
...
public class ContentLibraryImageConnection {
  ...
  public ContentLibraryImageConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this ContentLibraryImageConnection object is equal to o.
   */
  @Override
