 ...
 */
@JsonPropertyOrder({
  BrickTopoConnection.JSON_PROPERTY_AGGREGATE
})
...
public class BrickTopoConnection {
  ...
  public BrickTopoConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this BrickTopoConnection object is equal to o.
   */
  @Override
