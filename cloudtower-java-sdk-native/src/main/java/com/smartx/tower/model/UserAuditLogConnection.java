 ...
 */
@JsonPropertyOrder({
  UserAuditLogConnection.JSON_PROPERTY_AGGREGATE
})
...
public class UserAuditLogConnection {
  ...
  public UserAuditLogConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this UserAuditLogConnection object is equal to o.
   */
  @Override
