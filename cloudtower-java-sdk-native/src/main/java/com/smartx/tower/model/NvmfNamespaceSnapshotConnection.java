 ...
 */
@JsonPropertyOrder({
  NvmfNamespaceSnapshotConnection.JSON_PROPERTY_AGGREGATE
})
...
public class NvmfNamespaceSnapshotConnection {
  ...
  public NvmfNamespaceSnapshotConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this NvmfNamespaceSnapshotConnection object is equal to o.
   */
  @Override
