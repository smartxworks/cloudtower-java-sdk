 ...
 */
@JsonPropertyOrder({
  GetVmSnapshotsConnectionRequestBody.JSON_PROPERTY_AFTER,
  GetVmSnapshotsConnectionRequestBody.JSON_PROPERTY_BEFORE,
  GetVmSnapshotsConnectionRequestBody.JSON_PROPERTY_FIRST,
  GetVmSnapshotsConnectionRequestBody.JSON_PROPERTY_LAST,
  GetVmSnapshotsConnectionRequestBody.JSON_PROPERTY_ORDER_BY,
  GetVmSnapshotsConnectionRequestBody.JSON_PROPERTY_SKIP,
  GetVmSnapshotsConnectionRequestBody.JSON_PROPERTY_WHERE
})
...
public class GetVmSnapshotsConnectionRequestBody {
  ...
  private JsonNullable<VmSnapshotOrderByInput> orderBy = JsonNullable.<VmSnapshotOrderByInput>undefined();
  ...
  private JsonNullable<VmSnapshotWhereInput> where = JsonNullable.<VmSnapshotWhereInput>undefined();
  ...
  **/
  ...
  public GetVmSnapshotsConnectionRequestBody first(Double first) {
  ...
  **/
  ...
  public GetVmSnapshotsConnectionRequestBody last(Double last) {
  ...
  **/
  ...
  public GetVmSnapshotsConnectionRequestBody orderBy(VmSnapshotOrderByInput orderBy) {
    this.orderBy = JsonNullable.<VmSnapshotOrderByInput>of(orderBy);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<VmSnapshotOrderByInput> getOrderBy_JsonNullable() {
    return orderBy;
  }
  
  @JsonProperty(JSON_PROPERTY_ORDER_BY)
  public void setOrderBy_JsonNullable(JsonNullable<VmSnapshotOrderByInput> orderBy) {
  ...
  public GetVmSnapshotsConnectionRequestBody skip(Double skip) {
  ...
  **/
  ...
  public GetVmSnapshotsConnectionRequestBody where(VmSnapshotWhereInput where) {
    this.where = JsonNullable.<VmSnapshotWhereInput>of(where);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<VmSnapshotWhereInput> getWhere_JsonNullable() {
    return where;
  }
  
  @JsonProperty(JSON_PROPERTY_WHERE)
  public void setWhere_JsonNullable(JsonNullable<VmSnapshotWhereInput> where) {
    this.where = where;
  }
  ...
  /**
   * Return true if this GetVmSnapshotsConnectionRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.after, getVmSnapshotsConnectionRequestBody.after) &&
        equalsNullable(this.before, getVmSnapshotsConnectionRequestBody.before) &&
        equalsNullable(this.first, getVmSnapshotsConnectionRequestBody.first) &&
        equalsNullable(this.last, getVmSnapshotsConnectionRequestBody.last) &&
        equalsNullable(this.orderBy, getVmSnapshotsConnectionRequestBody.orderBy) &&
        equalsNullable(this.skip, getVmSnapshotsConnectionRequestBody.skip) &&
        equalsNullable(this.where, getVmSnapshotsConnectionRequestBody.where);
  }
