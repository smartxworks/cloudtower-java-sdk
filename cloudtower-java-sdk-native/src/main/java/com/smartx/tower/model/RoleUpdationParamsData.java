 ...
 */
@JsonPropertyOrder({
  RoleUpdationParamsData.JSON_PROPERTY_ACTIONS,
  RoleUpdationParamsData.JSON_PROPERTY_NAME
})
...
public class RoleUpdationParamsData {
  ...
  public RoleUpdationParamsData actions(List<String> actions) {
    this.actions = actions;
    return this;
  }

  public RoleUpdationParamsData addActionsItem(String actionsItem) {
  ...
  **/
  ...
  /**
   * Return true if this RoleUpdationParams_data object is equal to o.
   */
  @Override
