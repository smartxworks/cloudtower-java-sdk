 ...
 */
@JsonPropertyOrder({
  NfsExportConnection.JSON_PROPERTY_AGGREGATE
})
...
public class NfsExportConnection {
  ...
  public NfsExportConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this NfsExportConnection object is equal to o.
   */
  @Override
