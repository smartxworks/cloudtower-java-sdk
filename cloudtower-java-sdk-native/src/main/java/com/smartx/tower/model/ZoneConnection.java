 ...
 */
@JsonPropertyOrder({
  ZoneConnection.JSON_PROPERTY_AGGREGATE
})
...
public class ZoneConnection {
  ...
  public ZoneConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this ZoneConnection object is equal to o.
   */
  @Override
