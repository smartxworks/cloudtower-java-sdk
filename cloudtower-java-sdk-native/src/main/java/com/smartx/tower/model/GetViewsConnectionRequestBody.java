 ...
 */
@JsonPropertyOrder({
  GetViewsConnectionRequestBody.JSON_PROPERTY_AFTER,
  GetViewsConnectionRequestBody.JSON_PROPERTY_BEFORE,
  GetViewsConnectionRequestBody.JSON_PROPERTY_FIRST,
  GetViewsConnectionRequestBody.JSON_PROPERTY_LAST,
  GetViewsConnectionRequestBody.JSON_PROPERTY_ORDER_BY,
  GetViewsConnectionRequestBody.JSON_PROPERTY_SKIP,
  GetViewsConnectionRequestBody.JSON_PROPERTY_WHERE
})
...
public class GetViewsConnectionRequestBody {
  ...
  private JsonNullable<ViewOrderByInput> orderBy = JsonNullable.<ViewOrderByInput>undefined();
  ...
  private JsonNullable<ViewWhereInput> where = JsonNullable.<ViewWhereInput>undefined();
  ...
  **/
  ...
  public GetViewsConnectionRequestBody first(Double first) {
  ...
  **/
  ...
  public GetViewsConnectionRequestBody last(Double last) {
  ...
  **/
  ...
  public GetViewsConnectionRequestBody orderBy(ViewOrderByInput orderBy) {
    this.orderBy = JsonNullable.<ViewOrderByInput>of(orderBy);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<ViewOrderByInput> getOrderBy_JsonNullable() {
    return orderBy;
  }
  
  @JsonProperty(JSON_PROPERTY_ORDER_BY)
  public void setOrderBy_JsonNullable(JsonNullable<ViewOrderByInput> orderBy) {
  ...
  public GetViewsConnectionRequestBody skip(Double skip) {
  ...
  **/
  ...
  public GetViewsConnectionRequestBody where(ViewWhereInput where) {
    this.where = JsonNullable.<ViewWhereInput>of(where);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<ViewWhereInput> getWhere_JsonNullable() {
    return where;
  }
  
  @JsonProperty(JSON_PROPERTY_WHERE)
  public void setWhere_JsonNullable(JsonNullable<ViewWhereInput> where) {
    this.where = where;
  }
  ...
  /**
   * Return true if this GetViewsConnectionRequestBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.after, getViewsConnectionRequestBody.after) &&
        equalsNullable(this.before, getViewsConnectionRequestBody.before) &&
        equalsNullable(this.first, getViewsConnectionRequestBody.first) &&
        equalsNullable(this.last, getViewsConnectionRequestBody.last) &&
        equalsNullable(this.orderBy, getViewsConnectionRequestBody.orderBy) &&
        equalsNullable(this.skip, getViewsConnectionRequestBody.skip) &&
        equalsNullable(this.where, getViewsConnectionRequestBody.where);
  }
