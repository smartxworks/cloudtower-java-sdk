 ...
 */
@JsonPropertyOrder({
  AlertRuleConnection.JSON_PROPERTY_AGGREGATE
})
...
public class AlertRuleConnection {
  ...
  public AlertRuleConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this AlertRuleConnection object is equal to o.
   */
  @Override
