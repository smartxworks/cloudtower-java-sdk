 ...
 */
@JsonPropertyOrder({
  SnapshotPlanConnection.JSON_PROPERTY_AGGREGATE
})
...
public class SnapshotPlanConnection {
  ...
  public SnapshotPlanConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this SnapshotPlanConnection object is equal to o.
   */
  @Override
