 ...
 */
@JsonPropertyOrder({
  NicConnection.JSON_PROPERTY_AGGREGATE
})
...
public class NicConnection {
  ...
  public NicConnection aggregate(AlertNotifierConnectionAggregate aggregate) {
  ...
  **/
  ...
  /**
   * Return true if this NicConnection object is equal to o.
   */
  @Override
