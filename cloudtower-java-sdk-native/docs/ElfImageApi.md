...
ApiResponse<[**List&lt;WithTaskDeleteElfImage&gt;**](WithTaskDeleteElfImage.md)>
...
> ApiResponse<List<WithTaskElfImage>> updateElfImage updateElfImageWithHttpInfo(contentLanguage, elfImageUpdationParams)
