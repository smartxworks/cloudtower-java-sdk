...
public class EveroutePackageWhereInput {
  ...
  public static final String SERIALIZED_NAME_PVC_NAME_CONTAINS = "pvc_name_contains";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_CONTAINS)
  private String pvcNameContains;

  public static final String SERIALIZED_NAME_PVC_NAME_ENDS_WITH = "pvc_name_ends_with";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_ENDS_WITH)
  private String pvcNameEndsWith;

  public static final String SERIALIZED_NAME_PVC_NAME_GT = "pvc_name_gt";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_GT)
  private String pvcNameGt;

  public static final String SERIALIZED_NAME_PVC_NAME_GTE = "pvc_name_gte";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_GTE)
  private String pvcNameGte;

  public static final String SERIALIZED_NAME_PVC_NAME_IN = "pvc_name_in";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_IN)
  private List<String> pvcNameIn = null;

  public static final String SERIALIZED_NAME_PVC_NAME_LT = "pvc_name_lt";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_LT)
  private String pvcNameLt;

  public static final String SERIALIZED_NAME_PVC_NAME_LTE = "pvc_name_lte";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_LTE)
  private String pvcNameLte;

  public static final String SERIALIZED_NAME_PVC_NAME_NOT = "pvc_name_not";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_NOT)
  private String pvcNameNot;

  public static final String SERIALIZED_NAME_PVC_NAME_NOT_CONTAINS = "pvc_name_not_contains";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_NOT_CONTAINS)
  private String pvcNameNotContains;

  public static final String SERIALIZED_NAME_PVC_NAME_NOT_ENDS_WITH = "pvc_name_not_ends_with";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_NOT_ENDS_WITH)
  private String pvcNameNotEndsWith;

  public static final String SERIALIZED_NAME_PVC_NAME_NOT_IN = "pvc_name_not_in";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_NOT_IN)
  private List<String> pvcNameNotIn = null;

  public static final String SERIALIZED_NAME_PVC_NAME_NOT_STARTS_WITH = "pvc_name_not_starts_with";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_NOT_STARTS_WITH)
  private String pvcNameNotStartsWith;

  public static final String SERIALIZED_NAME_PVC_NAME_STARTS_WITH = "pvc_name_starts_with";
  @SerializedName(SERIALIZED_NAME_PVC_NAME_STARTS_WITH)
  private String pvcNameStartsWith;
  ...
  **/
  ...
  public EveroutePackageWhereInput addPvcNameInItem(String pvcNameInItem) {
    if (this.pvcNameIn == null) {
      this.pvcNameIn = new ArrayList<String>();
    }
    this.pvcNameIn.add(pvcNameInItem);
    return this;
  }
  ...
  **/
  ...
  public EveroutePackageWhereInput addPvcNameNotInItem(String pvcNameNotInItem) {
    if (this.pvcNameNotIn == null) {
      this.pvcNameNotIn = new ArrayList<String>();
    }
    this.pvcNameNotIn.add(pvcNameNotInItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.AND, everoutePackageWhereInput.AND) &&
        ...
        Objects.equals(this.pvcName, everoutePackageWhereInput.pvcName) &&
        Objects.equals(this.pvcNameContains, everoutePackageWhereInput.pvcNameContains) &&
        Objects.equals(this.pvcNameEndsWith, everoutePackageWhereInput.pvcNameEndsWith) &&
        Objects.equals(this.pvcNameGt, everoutePackageWhereInput.pvcNameGt) &&
        Objects.equals(this.pvcNameGte, everoutePackageWhereInput.pvcNameGte) &&
        Objects.equals(this.pvcNameIn, everoutePackageWhereInput.pvcNameIn) &&
        Objects.equals(this.pvcNameLt, everoutePackageWhereInput.pvcNameLt) &&
        Objects.equals(this.pvcNameLte, everoutePackageWhereInput.pvcNameLte) &&
        Objects.equals(this.pvcNameNot, everoutePackageWhereInput.pvcNameNot) &&
        Objects.equals(this.pvcNameNotContains, everoutePackageWhereInput.pvcNameNotContains) &&
        Objects.equals(this.pvcNameNotEndsWith, everoutePackageWhereInput.pvcNameNotEndsWith) &&
        Objects.equals(this.pvcNameNotIn, everoutePackageWhereInput.pvcNameNotIn) &&
        Objects.equals(this.pvcNameNotStartsWith, everoutePackageWhereInput.pvcNameNotStartsWith) &&
        Objects.equals(this.pvcNameStartsWith, everoutePackageWhereInput.pvcNameStartsWith) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(AND, arch, archIn, archNot, archNotIn, description, descriptionContains, descriptionEndsWith, descriptionGt, descriptionGte, descriptionIn, descriptionLt, descriptionLte, descriptionNot, descriptionNotContains, descriptionNotEndsWith, descriptionNotIn, descriptionNotStartsWith, descriptionStartsWith, entityAsyncStatus, entityAsyncStatusIn, entityAsyncStatusNot, entityAsyncStatusNotIn, id, idContains, idEndsWith, idGt, idGte, idIn, idLt, idLte, idNot, idNotContains, idNotEndsWith, idNotIn, idNotStartsWith, idStartsWith, localCreatedAt, localCreatedAtGt, localCreatedAtGte, localCreatedAtIn, localCreatedAtLt, localCreatedAtLte, localCreatedAtNot, localCreatedAtNotIn, name, nameContains, nameEndsWith, nameGt, nameGte, nameIn, nameLt, nameLte, nameNot, nameNotContains, nameNotEndsWith, nameNotIn, nameNotStartsWith, nameStartsWith, NOT, OR, pvcName, pvcNameContains, pvcNameEndsWith, pvcNameGt, pvcNameGte, pvcNameIn, pvcNameLt, pvcNameLte, pvcNameNot, pvcNameNotContains, pvcNameNotEndsWith, pvcNameNotIn, pvcNameNotStartsWith, pvcNameStartsWith, size, sizeGt, sizeGte, sizeIn, sizeLt, sizeLte, sizeNot, sizeNotIn, version, versionContains, versionEndsWith, versionGt, versionGte, versionIn, versionLt, versionLte, versionNot, versionNotContains, versionNotEndsWith, versionNotIn, versionNotStartsWith, versionStartsWith);
  }
