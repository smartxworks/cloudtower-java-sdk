...
import com.smartx.tower.auth.HttpBasicAuth;
import com.smartx.tower.auth.HttpBearerAuth;
...
public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      Interceptor auth;
      if ("Authorization".equals(authName)) {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "http://localhost/v2/api";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
