...
import com.smartx.tower.model.TaskCreationParams;
import com.smartx.tower.model.TaskUpdateParams;
import com.smartx.tower.model.WithTaskTask;
...
public class TaskApi {
     ...
     * @param taskCreationParams  (required)
     ...
     */
    public okhttp3.Call createTaskCall(List<TaskCreationParams> taskCreationParams, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = taskCreationParams;

        // create path and map variables
        String localVarPath = "/create-task";
    ...
    private okhttp3.Call createTaskValidateBeforeCall(List<TaskCreationParams> taskCreationParams, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'taskCreationParams' is set
        if (taskCreationParams == null) {
            throw new ApiException("Missing the required parameter 'taskCreationParams' when calling createTask(Async)");
        }
        

        okhttp3.Call localVarCall = createTaskCall(taskCreationParams, _callback);
        return localVarCall;
     ...
     */
    public List<WithTaskTask> createTask(List<TaskCreationParams> taskCreationParams) throws ApiException {
        ApiResponse<List<WithTaskTask>> localVarResp = createTaskWithHttpInfo(taskCreationParams);
     ...
     * 
     * @param taskCreationParams  (required)
     * @return ApiResponse&lt;List&lt;WithTaskTask&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<WithTaskTask>> createTaskWithHttpInfo(List<TaskCreationParams> taskCreationParams) throws ApiException {
        okhttp3.Call localVarCall = createTaskValidateBeforeCall(taskCreationParams, null);
        Type localVarReturnType = new TypeToken<List<WithTaskTask>>(){}.getType();
     ...
     */
    public okhttp3.Call createTaskAsync(List<TaskCreationParams> taskCreationParams, final ApiCallback<List<WithTaskTask>> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTaskValidateBeforeCall(taskCreationParams, _callback);
        Type localVarReturnType = new TypeToken<List<WithTaskTask>>(){}.getType();
     ...
     * @param taskUpdateParams  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateTaskCall(TaskUpdateParams taskUpdateParams, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        Object localVarPostBody = taskUpdateParams;

        // create path and map variables
        String localVarPath = "/update-task";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateTaskValidateBeforeCall(TaskUpdateParams taskUpdateParams, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'taskUpdateParams' is set
        if (taskUpdateParams == null) {
            throw new ApiException("Missing the required parameter 'taskUpdateParams' when calling updateTask(Async)");
        }
        

        okhttp3.Call localVarCall = updateTaskCall(taskUpdateParams, _callback);
        return localVarCall;
     ...
     */
    public List<WithTaskTask> updateTask(TaskUpdateParams taskUpdateParams) throws ApiException {
        ApiResponse<List<WithTaskTask>> localVarResp = updateTaskWithHttpInfo(taskUpdateParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<WithTaskTask>> updateTaskWithHttpInfo(TaskUpdateParams taskUpdateParams) throws ApiException {
        okhttp3.Call localVarCall = updateTaskValidateBeforeCall(taskUpdateParams, null);
        Type localVarReturnType = new TypeToken<List<WithTaskTask>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateTaskAsync(TaskUpdateParams taskUpdateParams, final ApiCallback<List<WithTaskTask>> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateTaskValidateBeforeCall(taskUpdateParams, _callback);
        Type localVarReturnType = new TypeToken<List<WithTaskTask>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
