...
public class NicApi {
    ...
    public okhttp3.Call updateNicCall(
            NicUpdationParams nicUpdationParams, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    private okhttp3.Call updateNicValidateBeforeCall(
        ...
        if (nicUpdationParams == null) {
            throw new ApiException(
                    "Missing the required parameter 'nicUpdationParams' when calling"
                            + " updateNic(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<List<WithTaskNic>> updateNicWithHttpInfo(NicUpdationParams nicUpdationParams)
            throws ApiException {
    ...
    public okhttp3.Call updateNicAsync(
            NicUpdationParams nicUpdationParams, final ApiCallback<List<WithTaskNic>> _callback)
            throws ApiException {
