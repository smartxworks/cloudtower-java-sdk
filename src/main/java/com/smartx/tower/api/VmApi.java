...
import com.smartx.tower.model.ExecuteCommandInVmParams;
import com.smartx.tower.model.ExecuteCommandInVmResponse;
...
public class VmApi {
    ...
    /**
     * Build call for executeCommandInVm
     *
     * @param executeCommandInVmParams (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * </table>
     */
    public okhttp3.Call executeCommandInVmCall(
            ExecuteCommandInVmParams executeCommandInVmParams, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        ...
        Object localVarPostBody = executeCommandInVmParams;

        // create path and map variables
        String localVarPath = "/execute-command-in-vm";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call executeCommandInVmValidateBeforeCall(
            ExecuteCommandInVmParams executeCommandInVmParams, final ApiCallback _callback)
            throws ApiException {

        // verify the required parameter 'executeCommandInVmParams' is set
        if (executeCommandInVmParams == null) {
            throw new ApiException(
                    "Missing the required parameter 'executeCommandInVmParams' when calling"
                            + " executeCommandInVm(Async)");
        }

        okhttp3.Call localVarCall = executeCommandInVmCall(executeCommandInVmParams, _callback);
        return localVarCall;
    }

    /**
     * @param executeCommandInVmParams (required)
     * @return ExecuteCommandInVmResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     *     response body
     * @http.response.details
     *     <table summary="Response Details" border="1">
     ...
     * </table>
     */
    public ExecuteCommandInVmResponse executeCommandInVm(
            ExecuteCommandInVmParams executeCommandInVmParams) throws ApiException {
        ApiResponse<ExecuteCommandInVmResponse> localVarResp =
                executeCommandInVmWithHttpInfo(executeCommandInVmParams);
        return localVarResp.getData();
    }

    /**
     * @param executeCommandInVmParams (required)
     * @return ApiResponse&lt;ExecuteCommandInVmResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     *     response body
     * @http.response.details
     *     <table summary="Response Details" border="1">
     ...
     * </table>
     */
    public ApiResponse<ExecuteCommandInVmResponse> executeCommandInVmWithHttpInfo(
            ExecuteCommandInVmParams executeCommandInVmParams) throws ApiException {
        okhttp3.Call localVarCall =
                executeCommandInVmValidateBeforeCall(executeCommandInVmParams, null);
        Type localVarReturnType = new TypeToken<ExecuteCommandInVmResponse>() {}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * </table>
     */
    public okhttp3.Call executeCommandInVmAsync(
            ExecuteCommandInVmParams executeCommandInVmParams,
            final ApiCallback<ExecuteCommandInVmResponse> _callback)
            throws ApiException {

        okhttp3.Call localVarCall =
                executeCommandInVmValidateBeforeCall(executeCommandInVmParams, _callback);
        Type localVarReturnType = new TypeToken<ExecuteCommandInVmResponse>() {}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
