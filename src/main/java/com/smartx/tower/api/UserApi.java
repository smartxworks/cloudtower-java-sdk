...
public class UserApi {
     ...
     */
    public okhttp3.Call getMyInfoCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/get-my-info";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMyInfoValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getMyInfoCall(_callback);
        return localVarCall;
     ...
     */
    public User getMyInfo() throws ApiException {
        ApiResponse<User> localVarResp = getMyInfoWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<User> getMyInfoWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getMyInfoValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call getMyInfoAsync(final ApiCallback<User> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMyInfoValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<User>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
