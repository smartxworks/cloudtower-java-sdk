...
public class GlobalSettingsApi {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateAccessRestrictionValidateBeforeCall(UpdateAccessRestrictionParams updateAccessRestrictionParams, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'updateAccessRestrictionParams' is set
        if (updateAccessRestrictionParams == null) {
            throw new ApiException("Missing the required parameter 'updateAccessRestrictionParams' when calling updateAccessRestriction(Async)");
        }
        

        okhttp3.Call localVarCall = updateAccessRestrictionCall(updateAccessRestrictionParams, _callback);
        return localVarCall;
    ...
    public WithTaskGlobalSettings updateAccessRestriction(UpdateAccessRestrictionParams updateAccessRestrictionParams) throws ApiException {
        ApiResponse<WithTaskGlobalSettings> localVarResp = updateAccessRestrictionWithHttpInfo(updateAccessRestrictionParams);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<WithTaskGlobalSettings> updateAccessRestrictionWithHttpInfo(UpdateAccessRestrictionParams updateAccessRestrictionParams) throws ApiException {
        okhttp3.Call localVarCall = updateAccessRestrictionValidateBeforeCall(updateAccessRestrictionParams, null);
    ...
    public okhttp3.Call updateAccessRestrictionAsync(UpdateAccessRestrictionParams updateAccessRestrictionParams, final ApiCallback<WithTaskGlobalSettings> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateAccessRestrictionValidateBeforeCall(updateAccessRestrictionParams, _callback);
        Type localVarReturnType = new TypeToken<WithTaskGlobalSettings>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updatePasswordSecurityValidateBeforeCall(UpdatePassrodSecurityParams updatePassrodSecurityParams, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'updatePassrodSecurityParams' is set
        if (updatePassrodSecurityParams == null) {
            throw new ApiException("Missing the required parameter 'updatePassrodSecurityParams' when calling updatePasswordSecurity(Async)");
        }
        

        okhttp3.Call localVarCall = updatePasswordSecurityCall(updatePassrodSecurityParams, _callback);
        return localVarCall;
    ...
    public WithTaskGlobalSettings updatePasswordSecurity(UpdatePassrodSecurityParams updatePassrodSecurityParams) throws ApiException {
        ApiResponse<WithTaskGlobalSettings> localVarResp = updatePasswordSecurityWithHttpInfo(updatePassrodSecurityParams);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<WithTaskGlobalSettings> updatePasswordSecurityWithHttpInfo(UpdatePassrodSecurityParams updatePassrodSecurityParams) throws ApiException {
        okhttp3.Call localVarCall = updatePasswordSecurityValidateBeforeCall(updatePassrodSecurityParams, null);
        Type localVarReturnType = new TypeToken<WithTaskGlobalSettings>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call updatePasswordSecurityAsync(UpdatePassrodSecurityParams updatePassrodSecurityParams, final ApiCallback<WithTaskGlobalSettings> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updatePasswordSecurityValidateBeforeCall(updatePassrodSecurityParams, _callback);
        Type localVarReturnType = new TypeToken<WithTaskGlobalSettings>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSessionTimeoutValidateBeforeCall(UpdateSessionTimeoutParams updateSessionTimeoutParams, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'updateSessionTimeoutParams' is set
        if (updateSessionTimeoutParams == null) {
            throw new ApiException("Missing the required parameter 'updateSessionTimeoutParams' when calling updateSessionTimeout(Async)");
        }
    ...
    public WithTaskGlobalSettings updateSessionTimeout(UpdateSessionTimeoutParams updateSessionTimeoutParams) throws ApiException {
        ApiResponse<WithTaskGlobalSettings> localVarResp = updateSessionTimeoutWithHttpInfo(updateSessionTimeoutParams);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<WithTaskGlobalSettings> updateSessionTimeoutWithHttpInfo(UpdateSessionTimeoutParams updateSessionTimeoutParams) throws ApiException {
        okhttp3.Call localVarCall = updateSessionTimeoutValidateBeforeCall(updateSessionTimeoutParams, null);
        Type localVarReturnType = new TypeToken<WithTaskGlobalSettings>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call updateSessionTimeoutAsync(UpdateSessionTimeoutParams updateSessionTimeoutParams, final ApiCallback<WithTaskGlobalSettings> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateSessionTimeoutValidateBeforeCall(updateSessionTimeoutParams, _callback);
        Type localVarReturnType = new TypeToken<WithTaskGlobalSettings>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
