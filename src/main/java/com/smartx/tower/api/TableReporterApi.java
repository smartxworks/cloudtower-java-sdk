...
public class TableReporterApi {
     ...
     * </table>
     */
    public okhttp3.Call exportCSVCall(
            TableReporterParams tableReporterParams, final ApiCallback _callback)
            throws ApiException {
    ...
    private okhttp3.Call exportCSVValidateBeforeCall(
            TableReporterParams tableReporterParams, final ApiCallback _callback)
            throws ApiException {
        ...
        if (tableReporterParams == null) {
            throw new ApiException(
                    "Missing the required parameter 'tableReporterParams' when calling"
                            + " exportCSV(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<byte[]> exportCSVWithHttpInfo(TableReporterParams tableReporterParams)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call exportCSVAsync(
            TableReporterParams tableReporterParams, final ApiCallback<byte[]> _callback)
            throws ApiException {
