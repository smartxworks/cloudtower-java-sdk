...
public class UsbDeviceApi {
     ...
     * </table>
     */
    public okhttp3.Call mountUsbDeviceCall(
            UsbDeviceMountParams usbDeviceMountParams, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call mountUsbDeviceValidateBeforeCall(
            UsbDeviceMountParams usbDeviceMountParams, final ApiCallback _callback)
            throws ApiException {
        ...
        if (usbDeviceMountParams == null) {
            throw new ApiException(
                    "Missing the required parameter 'usbDeviceMountParams' when calling"
                            + " mountUsbDevice(Async)");
        }
     ...
     * </table>
     */
    public List<WithTaskUsbDevice> mountUsbDevice(UsbDeviceMountParams usbDeviceMountParams)
            throws ApiException {
        ApiResponse<List<WithTaskUsbDevice>> localVarResp =
                mountUsbDeviceWithHttpInfo(usbDeviceMountParams);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<List<WithTaskUsbDevice>> mountUsbDeviceWithHttpInfo(
            UsbDeviceMountParams usbDeviceMountParams) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call mountUsbDeviceAsync(
            UsbDeviceMountParams usbDeviceMountParams,
            final ApiCallback<List<WithTaskUsbDevice>> _callback)
            throws ApiException {

        okhttp3.Call localVarCall =
                mountUsbDeviceValidateBeforeCall(usbDeviceMountParams, _callback);
        Type localVarReturnType = new TypeToken<List<WithTaskUsbDevice>>() {}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * </table>
     */
    public okhttp3.Call unmountUsbDeviceCall(
            UsbDeviceUnmountParams usbDeviceUnmountParams, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call unmountUsbDeviceValidateBeforeCall(
            UsbDeviceUnmountParams usbDeviceUnmountParams, final ApiCallback _callback)
            throws ApiException {
        ...
        if (usbDeviceUnmountParams == null) {
            throw new ApiException(
                    "Missing the required parameter 'usbDeviceUnmountParams' when calling"
                            + " unmountUsbDevice(Async)");
        }
     ...
     * </table>
     */
    public List<WithTaskUsbDevice> unmountUsbDevice(UsbDeviceUnmountParams usbDeviceUnmountParams)
            throws ApiException {
        ApiResponse<List<WithTaskUsbDevice>> localVarResp =
                unmountUsbDeviceWithHttpInfo(usbDeviceUnmountParams);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<List<WithTaskUsbDevice>> unmountUsbDeviceWithHttpInfo(
            UsbDeviceUnmountParams usbDeviceUnmountParams) throws ApiException {
        okhttp3.Call localVarCall =
                unmountUsbDeviceValidateBeforeCall(usbDeviceUnmountParams, null);
        Type localVarReturnType = new TypeToken<List<WithTaskUsbDevice>>() {}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * </table>
     */
    public okhttp3.Call unmountUsbDeviceAsync(
            UsbDeviceUnmountParams usbDeviceUnmountParams,
            final ApiCallback<List<WithTaskUsbDevice>> _callback)
            throws ApiException {

        okhttp3.Call localVarCall =
                unmountUsbDeviceValidateBeforeCall(usbDeviceUnmountParams, _callback);
        Type localVarReturnType = new TypeToken<List<WithTaskUsbDevice>>() {}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
