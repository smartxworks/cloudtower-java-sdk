...
import com.smartx.tower.model.NfsInodeUpdationParams;
import com.smartx.tower.model.WithTaskNfsInode;
...
public class NfsInodeApi {
    ...
    /**
     * Build call for updateNfsInode
     *
     * @param nfsInodeUpdationParams (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * </table>
     */
    public okhttp3.Call updateNfsInodeCall(
            NfsInodeUpdationParams nfsInodeUpdationParams, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        ...
        Object localVarPostBody = nfsInodeUpdationParams;

        // create path and map variables
        String localVarPath = "/update-nfs-inode";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateNfsInodeValidateBeforeCall(
            NfsInodeUpdationParams nfsInodeUpdationParams, final ApiCallback _callback)
            throws ApiException {

        // verify the required parameter 'nfsInodeUpdationParams' is set
        if (nfsInodeUpdationParams == null) {
            throw new ApiException(
                    "Missing the required parameter 'nfsInodeUpdationParams' when calling"
                            + " updateNfsInode(Async)");
        }

        okhttp3.Call localVarCall = updateNfsInodeCall(nfsInodeUpdationParams, _callback);
        return localVarCall;
    }

    /**
     * @param nfsInodeUpdationParams (required)
     * @return List&lt;WithTaskNfsInode&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     *     response body
     * @http.response.details
     *     <table summary="Response Details" border="1">
     ...
     * </table>
     */
    public List<WithTaskNfsInode> updateNfsInode(NfsInodeUpdationParams nfsInodeUpdationParams)
            throws ApiException {
        ApiResponse<List<WithTaskNfsInode>> localVarResp =
                updateNfsInodeWithHttpInfo(nfsInodeUpdationParams);
        return localVarResp.getData();
    }

    /**
     * @param nfsInodeUpdationParams (required)
     * @return ApiResponse&lt;List&lt;WithTaskNfsInode&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     *     response body
     * @http.response.details
     *     <table summary="Response Details" border="1">
     ...
     * </table>
     */
    public ApiResponse<List<WithTaskNfsInode>> updateNfsInodeWithHttpInfo(
            NfsInodeUpdationParams nfsInodeUpdationParams) throws ApiException {
        okhttp3.Call localVarCall = updateNfsInodeValidateBeforeCall(nfsInodeUpdationParams, null);
        Type localVarReturnType = new TypeToken<List<WithTaskNfsInode>>() {}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * </table>
     */
    public okhttp3.Call updateNfsInodeAsync(
            NfsInodeUpdationParams nfsInodeUpdationParams,
            final ApiCallback<List<WithTaskNfsInode>> _callback)
            throws ApiException {

        okhttp3.Call localVarCall =
                updateNfsInodeValidateBeforeCall(nfsInodeUpdationParams, _callback);
        Type localVarReturnType = new TypeToken<List<WithTaskNfsInode>>() {}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
