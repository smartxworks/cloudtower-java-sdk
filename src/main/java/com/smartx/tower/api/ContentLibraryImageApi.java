...
public class ContentLibraryImageApi {
     ...
     */
    public okhttp3.Call createContentLibraryImageCall(byte[] _file, String clusters, String name, String size, String description, String uploadTaskId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createContentLibraryImageValidateBeforeCall(byte[] _file, String clusters, String name, String size, String description, String uploadTaskId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createContentLibraryImageCall(_file, clusters, name, size, description, uploadTaskId, _callback);
        return localVarCall;
     ...
     */
    public List<UploadTask> createContentLibraryImage(byte[] _file, String clusters, String name, String size, String description, String uploadTaskId) throws ApiException {
        ApiResponse<List<UploadTask>> localVarResp = createContentLibraryImageWithHttpInfo(_file, clusters, name, size, description, uploadTaskId);
     ...
     */
    public ApiResponse<List<UploadTask>> createContentLibraryImageWithHttpInfo(byte[] _file, String clusters, String name, String size, String description, String uploadTaskId) throws ApiException {
        okhttp3.Call localVarCall = createContentLibraryImageValidateBeforeCall(_file, clusters, name, size, description, uploadTaskId, null);
     ...
     */
    public okhttp3.Call createContentLibraryImageAsync(byte[] _file, String clusters, String name, String size, String description, String uploadTaskId, final ApiCallback<List<UploadTask>> _callback) throws ApiException {

        okhttp3.Call localVarCall = createContentLibraryImageValidateBeforeCall(_file, clusters, name, size, description, uploadTaskId, _callback);
        Type localVarReturnType = new TypeToken<List<UploadTask>>(){}.getType();
