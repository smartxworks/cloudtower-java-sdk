...
public class NtpApi {
    ...
    private okhttp3.Call getNtpServiceUrlValidateBeforeCall(final ApiCallback _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call getNtpServiceUrlAsync(final ApiCallback<NtpServiceUrl> _callback)
            throws ApiException {
