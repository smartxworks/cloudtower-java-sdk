...
public class DeleteBackupPlan extends com.smartx.tower.ConditionalNullable.ConditionalNullablePojo {
    ...
    public DeleteBackupPlan entityAsyncStatus_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ENTITY_ASYNC_STATUS);
        return this;
    }

    public DeleteBackupPlan entityAsyncStatus_ExplictlyNonNull() {
    ...
    public DeleteBackupPlan id_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ID);
        return this;
    }

    public DeleteBackupPlan id_ExplictlyNonNull() {
