...
public class NestedAggregateBackupPlanExecution
    ...
    public NestedAggregateBackupPlanExecution count_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_COUNT);
        return this;
    }

    public NestedAggregateBackupPlanExecution count_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        NestedAggregateBackupPlanExecution nestedAggregateBackupPlanExecution =
                (NestedAggregateBackupPlanExecution) o;
