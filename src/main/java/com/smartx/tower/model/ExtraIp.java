...
public class ExtraIp extends com.smartx.tower.ConditionalNullable.ConditionalNullablePojo {
    ...
    public ExtraIp managementIp_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_MANAGEMENT_IP);
        return this;
    }

    public ExtraIp managementIp_ExplictlyNonNull() {
    ...
    public ExtraIp hostId_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_HOST_ID);
        return this;
    }

    public ExtraIp hostId_ExplictlyNonNull() {
