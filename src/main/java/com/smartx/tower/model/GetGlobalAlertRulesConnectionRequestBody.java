...
public class GetGlobalAlertRulesConnectionRequestBody
    ...
    public GetGlobalAlertRulesConnectionRequestBody() {}
    ...
    public GetGlobalAlertRulesConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetGlobalAlertRulesConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetGlobalAlertRulesConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesConnectionRequestBody first(Integer first) {
    ...
    public GetGlobalAlertRulesConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetGlobalAlertRulesConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesConnectionRequestBody last(Integer last) {
    ...
    public GetGlobalAlertRulesConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetGlobalAlertRulesConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetGlobalAlertRulesConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesConnectionRequestBody skip(Integer skip) {
    ...
    public GetGlobalAlertRulesConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetGlobalAlertRulesConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetGlobalAlertRulesConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetGlobalAlertRulesConnectionRequestBody getGlobalAlertRulesConnectionRequestBody =
                (GetGlobalAlertRulesConnectionRequestBody) o;
