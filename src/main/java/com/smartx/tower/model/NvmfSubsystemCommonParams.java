...
public class NvmfSubsystemCommonParams {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bpsWrMaxLength, bpsWrMaxUnit, bpsWrMax, bpsRdMaxLength, bpsRdMaxUnit, bpsRdMax, bpsMaxLength, bpsMaxUnit, bpsMax, iopsWrMaxLength, iopsWrMax, iopsRdMaxLength, iopsRdMax, iopsMaxLength, iopsMax, bpsWrUnit, bpsWr, bpsRdUnit, bpsRd, bpsUnit, bps, iopsWr, iopsRd, iops, description, nqnWhitelist, ipWhitelist);
  }
