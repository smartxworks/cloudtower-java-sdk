...
public class GetCloudTowerApplicationPackagesConnectionRequestBody
    ...
    public GetCloudTowerApplicationPackagesConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetCloudTowerApplicationPackagesConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetCloudTowerApplicationPackagesConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetCloudTowerApplicationPackagesConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetCloudTowerApplicationPackagesConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetCloudTowerApplicationPackagesConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetCloudTowerApplicationPackagesConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetCloudTowerApplicationPackagesConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetCloudTowerApplicationPackagesConnectionRequestBody orderBy(
    ...
    public GetCloudTowerApplicationPackagesConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetCloudTowerApplicationPackagesConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetCloudTowerApplicationPackagesConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetCloudTowerApplicationPackagesConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetCloudTowerApplicationPackagesConnectionRequestBody where(
    ...
    public GetCloudTowerApplicationPackagesConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetCloudTowerApplicationPackagesConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetCloudTowerApplicationPackagesConnectionRequestBody
                getCloudTowerApplicationPackagesConnectionRequestBody =
                        (GetCloudTowerApplicationPackagesConnectionRequestBody) o;
        return Objects.equals(
                        this.after, getCloudTowerApplicationPackagesConnectionRequestBody.after)
                && Objects.equals(
                        this.before, getCloudTowerApplicationPackagesConnectionRequestBody.before)
                && Objects.equals(
                        this.first, getCloudTowerApplicationPackagesConnectionRequestBody.first)
                && Objects.equals(
                        this.last, getCloudTowerApplicationPackagesConnectionRequestBody.last)
                && Objects.equals(
                        this.orderBy, getCloudTowerApplicationPackagesConnectionRequestBody.orderBy)
                && Objects.equals(
                        this.skip, getCloudTowerApplicationPackagesConnectionRequestBody.skip)
                && Objects.equals(
                        this.where, getCloudTowerApplicationPackagesConnectionRequestBody.where);
    }
