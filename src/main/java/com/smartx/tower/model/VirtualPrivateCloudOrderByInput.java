...
public enum VirtualPrivateCloudOrderByInput {
  ...
  VIRTUALPRIVATECLOUDORDERBYINPUT_UNSUPPORTED_ENUM("VIRTUALPRIVATECLOUDORDERBYINPUT_UNSUPPORTED_ENUM");
  ...
  public static class Adapter extends TypeAdapter<VirtualPrivateCloudOrderByInput> {
    @Override
    public void write(final JsonWriter jsonWriter, final VirtualPrivateCloudOrderByInput enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VirtualPrivateCloudOrderByInput read(final JsonReader jsonReader) throws IOException {
