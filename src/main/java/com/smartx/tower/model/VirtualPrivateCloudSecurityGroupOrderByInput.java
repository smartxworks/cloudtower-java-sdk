...
public enum VirtualPrivateCloudSecurityGroupOrderByInput {
  ...
  VIRTUALPRIVATECLOUDSECURITYGROUPORDERBYINPUT_UNSUPPORTED_ENUM("VIRTUALPRIVATECLOUDSECURITYGROUPORDERBYINPUT_UNSUPPORTED_ENUM");
  ...
  public static VirtualPrivateCloudSecurityGroupOrderByInput fromValue(String value) {
    for (VirtualPrivateCloudSecurityGroupOrderByInput b : VirtualPrivateCloudSecurityGroupOrderByInput.values()) {
      if (b.value.equals(value)) {
        return b;
      }
    }
    return VirtualPrivateCloudSecurityGroupOrderByInput.VIRTUALPRIVATECLOUDSECURITYGROUPORDERBYINPUT_UNSUPPORTED_ENUM;
  }

  public static class Adapter extends TypeAdapter<VirtualPrivateCloudSecurityGroupOrderByInput> {
    @Override
    public void write(final JsonWriter jsonWriter, final VirtualPrivateCloudSecurityGroupOrderByInput enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VirtualPrivateCloudSecurityGroupOrderByInput read(final JsonReader jsonReader) throws IOException {
