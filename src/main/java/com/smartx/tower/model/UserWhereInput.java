...
import com.smartx.tower.model.UserLoginInfoWhereInput;
...
public class UserWhereInput {
  ...
  private UserLoginInfoWhereInput loginInfo;
  ...
  **/
  ...
  public UserWhereInput loginInfo(UserLoginInfoWhereInput loginInfo) {
  ...
  **/
  ...
  public UserLoginInfoWhereInput getLoginInfo() {
    return loginInfo;
  }


  public void setLoginInfo(UserLoginInfoWhereInput loginInfo) {
    this.loginInfo = loginInfo;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.AND, userWhereInput.AND) &&
        ...
        Objects.equals(this.loginInfo, userWhereInput.loginInfo) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(AND, NOT, OR, emailAddress, emailAddressContains, emailAddressEndsWith, emailAddressGt, emailAddressGte, emailAddressIn, emailAddressLt, emailAddressLte, emailAddressNot, emailAddressNotContains, emailAddressNotEndsWith, emailAddressNotIn, emailAddressNotStartsWith, emailAddressStartsWith, id, idContains, idEndsWith, idGt, idGte, idIn, idLt, idLte, idNot, idNotContains, idNotEndsWith, idNotIn, idNotStartsWith, idStartsWith, internal, internalNot, ldapDn, ldapDnContains, ldapDnEndsWith, ldapDnGt, ldapDnGte, ldapDnIn, ldapDnLt, ldapDnLte, ldapDnNot, ldapDnNotContains, ldapDnNotEndsWith, ldapDnNotIn, ldapDnNotStartsWith, ldapDnStartsWith, loginInfo, mobilePhone, mobilePhoneContains, mobilePhoneEndsWith, mobilePhoneGt, mobilePhoneGte, mobilePhoneIn, mobilePhoneLt, mobilePhoneLte, mobilePhoneNot, mobilePhoneNotContains, mobilePhoneNotEndsWith, mobilePhoneNotIn, mobilePhoneNotStartsWith, mobilePhoneStartsWith, name, nameContains, nameEndsWith, nameGt, nameGte, nameIn, nameLt, nameLte, nameNot, nameNotContains, nameNotEndsWith, nameNotIn, nameNotStartsWith, nameStartsWith, password, passwordContains, passwordEndsWith, passwordExpired, passwordExpiredNot, passwordGt, passwordGte, passwordIn, passwordLt, passwordLte, passwordNot, passwordNotContains, passwordNotEndsWith, passwordNotIn, passwordNotStartsWith, passwordStartsWith, passwordUpdatedAt, passwordUpdatedAtGt, passwordUpdatedAtGte, passwordUpdatedAtIn, passwordUpdatedAtLt, passwordUpdatedAtLte, passwordUpdatedAtNot, passwordUpdatedAtNotIn, role, roleIn, roleNot, roleNotIn, rolesEvery, rolesNone, rolesSome, source, sourceIn, sourceNot, sourceNotIn, username, usernameContains, usernameEndsWith, usernameGt, usernameGte, usernameIn, usernameLt, usernameLte, usernameNot, usernameNotContains, usernameNotEndsWith, usernameNotIn, usernameNotStartsWith, usernameStartsWith);
  }
