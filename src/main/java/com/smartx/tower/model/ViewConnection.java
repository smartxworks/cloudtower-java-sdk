...
public class ViewConnection extends com.smartx.tower.ConditionalNullable.ConditionalNullablePojo {
    public static final String SERIALIZED_NAME_AGGREGATE = "aggregate";

    @SerializedName(SERIALIZED_NAME_AGGREGATE)
    private NestedAggregateView aggregate;
    ...
    public NestedAggregateView getAggregate() {
        return aggregate;
    }
    ...
    public boolean equals(Object o) {
        ...
        ViewConnection viewConnection = (ViewConnection) o;
        return Objects.equals(this.aggregate, viewConnection.aggregate);
    }
    ...
    public String toString() {
        ...
        sb.append("class ViewConnection {\n");
