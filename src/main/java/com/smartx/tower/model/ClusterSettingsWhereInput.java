...
public class ClusterSettingsWhereInput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(AND, cluster, defaultHa, defaultHaNot, id, idContains, idEndsWith, idGt, idGte, idIn, idLt, idLte, idNot, idNotContains, idNotEndsWith, idNotIn, idNotStartsWith, idStartsWith, NOT, OR);
  }
