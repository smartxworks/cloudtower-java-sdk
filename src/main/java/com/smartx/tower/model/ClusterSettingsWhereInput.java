...
public class ClusterSettingsWhereInput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(AND, NOT, OR, cluster, defaultHa, defaultHaNot, enabledIscsi, enabledIscsiNot, id, idContains, idEndsWith, idGt, idGte, idIn, idLt, idLte, idNot, idNotContains, idNotEndsWith, idNotIn, idNotStartsWith, idStartsWith);
  }
