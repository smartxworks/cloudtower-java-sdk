...
public class Graph {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cluster, disks, entityAsyncStatus, hosts, id, instanceIds, localId, luns, metricCount, metricName, metricType, namespaces, network, nics, resourceType, service, targets, title, type, view, vmNics, vmVolumes, vms, witnesses, zones);
  }
