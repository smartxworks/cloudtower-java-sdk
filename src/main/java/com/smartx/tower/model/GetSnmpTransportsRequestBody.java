...
public class GetSnmpTransportsRequestBody
    ...
    public GetSnmpTransportsRequestBody() {}

    public GetSnmpTransportsRequestBody after(String after) {
    ...
    public GetSnmpTransportsRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetSnmpTransportsRequestBody after_ExplictlyNonNull() {
    ...
    public GetSnmpTransportsRequestBody before(String before) {
    ...
    public GetSnmpTransportsRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetSnmpTransportsRequestBody before_ExplictlyNonNull() {
    ...
    public GetSnmpTransportsRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetSnmpTransportsRequestBody first_ExplictlyNonNull() {
    ...
    public GetSnmpTransportsRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetSnmpTransportsRequestBody last_ExplictlyNonNull() {
    ...
    public GetSnmpTransportsRequestBody orderBy(SnmpTransportOrderByInput orderBy) {
    ...
    public GetSnmpTransportsRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetSnmpTransportsRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetSnmpTransportsRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetSnmpTransportsRequestBody skip_ExplictlyNonNull() {
    ...
    public GetSnmpTransportsRequestBody where(SnmpTransportWhereInput where) {
    ...
    public GetSnmpTransportsRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetSnmpTransportsRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetSnmpTransportsRequestBody getSnmpTransportsRequestBody =
                (GetSnmpTransportsRequestBody) o;
        return Objects.equals(this.after, getSnmpTransportsRequestBody.after)
                && Objects.equals(this.before, getSnmpTransportsRequestBody.before)
                && Objects.equals(this.first, getSnmpTransportsRequestBody.first)
                && Objects.equals(this.last, getSnmpTransportsRequestBody.last)
                && Objects.equals(this.orderBy, getSnmpTransportsRequestBody.orderBy)
                && Objects.equals(this.skip, getSnmpTransportsRequestBody.skip)
                && Objects.equals(this.where, getSnmpTransportsRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetSnmpTransportsRequestBody {\n");
