...
public class GetViewsConnectionRequestBody
    ...
    public GetViewsConnectionRequestBody() {}
    ...
    public GetViewsConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetViewsConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetViewsConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetViewsConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetViewsConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetViewsConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetViewsConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetViewsConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetViewsConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetViewsConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetViewsConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetViewsConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetViewsConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetViewsConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetViewsConnectionRequestBody getViewsConnectionRequestBody =
                (GetViewsConnectionRequestBody) o;
        return Objects.equals(this.after, getViewsConnectionRequestBody.after)
                && Objects.equals(this.before, getViewsConnectionRequestBody.before)
                && Objects.equals(this.first, getViewsConnectionRequestBody.first)
                && Objects.equals(this.last, getViewsConnectionRequestBody.last)
                && Objects.equals(this.orderBy, getViewsConnectionRequestBody.orderBy)
                && Objects.equals(this.skip, getViewsConnectionRequestBody.skip)
                && Objects.equals(this.where, getViewsConnectionRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetViewsConnectionRequestBody {\n");
