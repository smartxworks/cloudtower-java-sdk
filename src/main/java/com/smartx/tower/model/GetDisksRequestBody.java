...
public class GetDisksRequestBody
    ...
    public GetDisksRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetDisksRequestBody after_ExplictlyNonNull() {
    ...
    public GetDisksRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetDisksRequestBody before_ExplictlyNonNull() {
    ...
    public GetDisksRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetDisksRequestBody first_ExplictlyNonNull() {
    ...
    public GetDisksRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetDisksRequestBody last_ExplictlyNonNull() {
    ...
    public GetDisksRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetDisksRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetDisksRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetDisksRequestBody skip_ExplictlyNonNull() {
    ...
    public GetDisksRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetDisksRequestBody where_ExplictlyNonNull() {
