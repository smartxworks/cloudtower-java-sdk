...
public class BackupRestoreExecution {
  ...
  **/
  ...
  public BackupRestoreExecution rebuildTargetHost(String rebuildTargetHost) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backupRestorePoint, duration, entityAsyncStatus, executedAt, id, mode, name, readBytes, rebuildName, rebuildNetworkMapping, rebuildTargetCluster, rebuildTargetHost, retryTimes, startupAfterRestore, status, totalBytes);
  }
