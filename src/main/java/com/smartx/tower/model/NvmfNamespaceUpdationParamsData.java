...
public class NvmfNamespaceUpdationParamsData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assignedSize, name, bps, bpsMax, bpsMaxLength, bpsRd, bpsRdMax, bpsRdMaxLength, bpsWr, bpsWrMax, bpsWrMaxLength, iops, iopsMax, iopsMaxLength, iopsRd, iopsRdMax, iopsRdMaxLength, iopsWr, iopsWrMax, iopsWrMaxLength, nqnWhitelist);
  }
