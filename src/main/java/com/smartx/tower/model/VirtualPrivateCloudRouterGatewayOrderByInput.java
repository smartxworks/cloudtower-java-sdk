...
public enum VirtualPrivateCloudRouterGatewayOrderByInput {
  ...
  VIRTUALPRIVATECLOUDROUTERGATEWAYORDERBYINPUT_UNSUPPORTED_ENUM("VIRTUALPRIVATECLOUDROUTERGATEWAYORDERBYINPUT_UNSUPPORTED_ENUM");
  ...
  public static VirtualPrivateCloudRouterGatewayOrderByInput fromValue(String value) {
    for (VirtualPrivateCloudRouterGatewayOrderByInput b : VirtualPrivateCloudRouterGatewayOrderByInput.values()) {
      if (b.value.equals(value)) {
        return b;
      }
    }
    return VirtualPrivateCloudRouterGatewayOrderByInput.VIRTUALPRIVATECLOUDROUTERGATEWAYORDERBYINPUT_UNSUPPORTED_ENUM;
  }

  public static class Adapter extends TypeAdapter<VirtualPrivateCloudRouterGatewayOrderByInput> {
    @Override
    public void write(final JsonWriter jsonWriter, final VirtualPrivateCloudRouterGatewayOrderByInput enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VirtualPrivateCloudRouterGatewayOrderByInput read(final JsonReader jsonReader) throws IOException {
