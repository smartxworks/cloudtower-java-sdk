...
public class GetSnapshotPlanTasksRequestBody
    ...
    public GetSnapshotPlanTasksRequestBody() {}
    ...
    public GetSnapshotPlanTasksRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetSnapshotPlanTasksRequestBody after_ExplictlyNonNull() {
    ...
    public GetSnapshotPlanTasksRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetSnapshotPlanTasksRequestBody before_ExplictlyNonNull() {
    ...
    public GetSnapshotPlanTasksRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetSnapshotPlanTasksRequestBody first_ExplictlyNonNull() {
    ...
    public GetSnapshotPlanTasksRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetSnapshotPlanTasksRequestBody last_ExplictlyNonNull() {
    ...
    public GetSnapshotPlanTasksRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetSnapshotPlanTasksRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetSnapshotPlanTasksRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetSnapshotPlanTasksRequestBody skip_ExplictlyNonNull() {
    ...
    public GetSnapshotPlanTasksRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetSnapshotPlanTasksRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetSnapshotPlanTasksRequestBody getSnapshotPlanTasksRequestBody =
                (GetSnapshotPlanTasksRequestBody) o;
        return Objects.equals(this.after, getSnapshotPlanTasksRequestBody.after)
                && Objects.equals(this.before, getSnapshotPlanTasksRequestBody.before)
                && Objects.equals(this.first, getSnapshotPlanTasksRequestBody.first)
                && Objects.equals(this.last, getSnapshotPlanTasksRequestBody.last)
                && Objects.equals(this.orderBy, getSnapshotPlanTasksRequestBody.orderBy)
                && Objects.equals(this.skip, getSnapshotPlanTasksRequestBody.skip)
                && Objects.equals(this.where, getSnapshotPlanTasksRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetSnapshotPlanTasksRequestBody {\n");
