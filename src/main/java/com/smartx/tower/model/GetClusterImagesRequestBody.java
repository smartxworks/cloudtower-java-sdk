...
public class GetClusterImagesRequestBody
    ...
    public GetClusterImagesRequestBody() {}
    ...
    public GetClusterImagesRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetClusterImagesRequestBody after_ExplictlyNonNull() {
    ...
    public GetClusterImagesRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetClusterImagesRequestBody before_ExplictlyNonNull() {
    ...
    public GetClusterImagesRequestBody first(Integer first) {
    ...
    public GetClusterImagesRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetClusterImagesRequestBody first_ExplictlyNonNull() {
    ...
    public GetClusterImagesRequestBody last(Integer last) {
    ...
    public GetClusterImagesRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetClusterImagesRequestBody last_ExplictlyNonNull() {
    ...
    public GetClusterImagesRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetClusterImagesRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetClusterImagesRequestBody skip(Integer skip) {
    ...
    public GetClusterImagesRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetClusterImagesRequestBody skip_ExplictlyNonNull() {
    ...
    public GetClusterImagesRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetClusterImagesRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.after, getClusterImagesRequestBody.after)
                && Objects.equals(this.before, getClusterImagesRequestBody.before)
                && Objects.equals(this.first, getClusterImagesRequestBody.first)
                && Objects.equals(this.last, getClusterImagesRequestBody.last)
                && Objects.equals(this.orderBy, getClusterImagesRequestBody.orderBy)
                && Objects.equals(this.skip, getClusterImagesRequestBody.skip)
                && Objects.equals(this.where, getClusterImagesRequestBody.where);
    }
