...
public class GetBackupPlansConnectionRequestBody
    ...
    public GetBackupPlansConnectionRequestBody() {}
    ...
    public GetBackupPlansConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetBackupPlansConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetBackupPlansConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetBackupPlansConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetBackupPlansConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetBackupPlansConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetBackupPlansConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetBackupPlansConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetBackupPlansConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetBackupPlansConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetBackupPlansConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetBackupPlansConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetBackupPlansConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetBackupPlansConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetBackupPlansConnectionRequestBody getBackupPlansConnectionRequestBody =
                (GetBackupPlansConnectionRequestBody) o;
        return Objects.equals(this.after, getBackupPlansConnectionRequestBody.after)
                && Objects.equals(this.before, getBackupPlansConnectionRequestBody.before)
                && Objects.equals(this.first, getBackupPlansConnectionRequestBody.first)
                && Objects.equals(this.last, getBackupPlansConnectionRequestBody.last)
                && Objects.equals(this.orderBy, getBackupPlansConnectionRequestBody.orderBy)
                && Objects.equals(this.skip, getBackupPlansConnectionRequestBody.skip)
                && Objects.equals(this.where, getBackupPlansConnectionRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetBackupPlansConnectionRequestBody {\n");
