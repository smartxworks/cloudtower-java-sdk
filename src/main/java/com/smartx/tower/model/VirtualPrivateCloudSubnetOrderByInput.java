...
public enum VirtualPrivateCloudSubnetOrderByInput {
  ...
  VIRTUALPRIVATECLOUDSUBNETORDERBYINPUT_UNSUPPORTED_ENUM("VIRTUALPRIVATECLOUDSUBNETORDERBYINPUT_UNSUPPORTED_ENUM");
  ...
  public static VirtualPrivateCloudSubnetOrderByInput fromValue(String value) {
    for (VirtualPrivateCloudSubnetOrderByInput b : VirtualPrivateCloudSubnetOrderByInput.values()) {
      if (b.value.equals(value)) {
        return b;
      }
    }
    return VirtualPrivateCloudSubnetOrderByInput.VIRTUALPRIVATECLOUDSUBNETORDERBYINPUT_UNSUPPORTED_ENUM;
  }

  public static class Adapter extends TypeAdapter<VirtualPrivateCloudSubnetOrderByInput> {
    @Override
    public void write(final JsonWriter jsonWriter, final VirtualPrivateCloudSubnetOrderByInput enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VirtualPrivateCloudSubnetOrderByInput read(final JsonReader jsonReader) throws IOException {
