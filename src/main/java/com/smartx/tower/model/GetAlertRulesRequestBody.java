...
public class GetAlertRulesRequestBody
    ...
    public GetAlertRulesRequestBody() {}

    public GetAlertRulesRequestBody after(String after) {
    ...
    public GetAlertRulesRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetAlertRulesRequestBody after_ExplictlyNonNull() {
    ...
    public GetAlertRulesRequestBody before(String before) {
    ...
    public GetAlertRulesRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetAlertRulesRequestBody before_ExplictlyNonNull() {
    ...
    public GetAlertRulesRequestBody first(Integer first) {
    ...
    public GetAlertRulesRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetAlertRulesRequestBody first_ExplictlyNonNull() {
    ...
    public GetAlertRulesRequestBody last(Integer last) {
    ...
    public GetAlertRulesRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetAlertRulesRequestBody last_ExplictlyNonNull() {
    ...
    public GetAlertRulesRequestBody orderBy(AlertRuleOrderByInput orderBy) {
    ...
    public GetAlertRulesRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetAlertRulesRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetAlertRulesRequestBody skip(Integer skip) {
    ...
    public GetAlertRulesRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetAlertRulesRequestBody skip_ExplictlyNonNull() {
    ...
    public GetAlertRulesRequestBody where(AlertRuleWhereInput where) {
    ...
    public GetAlertRulesRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetAlertRulesRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetAlertRulesRequestBody getAlertRulesRequestBody = (GetAlertRulesRequestBody) o;
        return Objects.equals(this.after, getAlertRulesRequestBody.after)
                && Objects.equals(this.before, getAlertRulesRequestBody.before)
                && Objects.equals(this.first, getAlertRulesRequestBody.first)
                && Objects.equals(this.last, getAlertRulesRequestBody.last)
                && Objects.equals(this.orderBy, getAlertRulesRequestBody.orderBy)
                && Objects.equals(this.skip, getAlertRulesRequestBody.skip)
                && Objects.equals(this.where, getAlertRulesRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetAlertRulesRequestBody {\n");
