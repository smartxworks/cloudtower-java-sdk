...
public enum VirtualPrivateCloudSecurityPolicyOrderByInput {
  ...
  VIRTUALPRIVATECLOUDSECURITYPOLICYORDERBYINPUT_UNSUPPORTED_ENUM("VIRTUALPRIVATECLOUDSECURITYPOLICYORDERBYINPUT_UNSUPPORTED_ENUM");
  ...
  public static VirtualPrivateCloudSecurityPolicyOrderByInput fromValue(String value) {
    for (VirtualPrivateCloudSecurityPolicyOrderByInput b : VirtualPrivateCloudSecurityPolicyOrderByInput.values()) {
      if (b.value.equals(value)) {
        return b;
      }
    }
    return VirtualPrivateCloudSecurityPolicyOrderByInput.VIRTUALPRIVATECLOUDSECURITYPOLICYORDERBYINPUT_UNSUPPORTED_ENUM;
  }

  public static class Adapter extends TypeAdapter<VirtualPrivateCloudSecurityPolicyOrderByInput> {
    @Override
    public void write(final JsonWriter jsonWriter, final VirtualPrivateCloudSecurityPolicyOrderByInput enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VirtualPrivateCloudSecurityPolicyOrderByInput read(final JsonReader jsonReader) throws IOException {
