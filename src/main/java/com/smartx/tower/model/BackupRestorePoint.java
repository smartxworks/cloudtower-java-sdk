...
public class BackupRestorePoint {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backupPlan, backupService, backupStoreRepository, backupTargetExecution, clusterLocalId, compressionRatio, creation, entityAsyncStatus, id, localCreatedAt, localId, logicalSize, parentRestorePoint, physicalSize, size, slice, type, validCapacity, validSize, vm, vmLocalId, vmName);
  }
