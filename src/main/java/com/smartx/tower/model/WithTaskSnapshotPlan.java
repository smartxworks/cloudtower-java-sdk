...
public class WithTaskSnapshotPlan
    ...
    public WithTaskSnapshotPlan taskId_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_TASK_ID);
        return this;
    }

    public WithTaskSnapshotPlan taskId_ExplictlyNonNull() {
    ...
    public WithTaskSnapshotPlan data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public WithTaskSnapshotPlan data_ExplictlyNonNull() {
