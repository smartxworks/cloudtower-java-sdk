...
public class VmEntityFilterResultConnection
    ...
    public VmEntityFilterResultConnection() {}
    ...
    public VmEntityFilterResultConnection aggregate_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AGGREGATE);
        return this;
    }

    public VmEntityFilterResultConnection aggregate_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        VmEntityFilterResultConnection vmEntityFilterResultConnection =
                (VmEntityFilterResultConnection) o;
