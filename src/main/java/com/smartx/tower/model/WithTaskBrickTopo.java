...
public class WithTaskBrickTopo
    ...
    public WithTaskBrickTopo taskId_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_TASK_ID);
        return this;
    }

    public WithTaskBrickTopo taskId_ExplictlyNonNull() {
    ...
    public WithTaskBrickTopo data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public WithTaskBrickTopo data_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.taskId, withTaskBrickTopo.taskId)
