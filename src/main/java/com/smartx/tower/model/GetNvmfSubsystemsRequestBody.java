...
public class GetNvmfSubsystemsRequestBody
    ...
    public GetNvmfSubsystemsRequestBody() {}
    ...
    public GetNvmfSubsystemsRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetNvmfSubsystemsRequestBody after_ExplictlyNonNull() {
    ...
    public GetNvmfSubsystemsRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetNvmfSubsystemsRequestBody before_ExplictlyNonNull() {
    ...
    public GetNvmfSubsystemsRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetNvmfSubsystemsRequestBody first_ExplictlyNonNull() {
    ...
    public GetNvmfSubsystemsRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetNvmfSubsystemsRequestBody last_ExplictlyNonNull() {
    ...
    public GetNvmfSubsystemsRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetNvmfSubsystemsRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetNvmfSubsystemsRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetNvmfSubsystemsRequestBody skip_ExplictlyNonNull() {
    ...
    public GetNvmfSubsystemsRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetNvmfSubsystemsRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetNvmfSubsystemsRequestBody getNvmfSubsystemsRequestBody =
                (GetNvmfSubsystemsRequestBody) o;
        return Objects.equals(this.after, getNvmfSubsystemsRequestBody.after)
                && Objects.equals(this.before, getNvmfSubsystemsRequestBody.before)
                && Objects.equals(this.first, getNvmfSubsystemsRequestBody.first)
                && Objects.equals(this.last, getNvmfSubsystemsRequestBody.last)
                && Objects.equals(this.orderBy, getNvmfSubsystemsRequestBody.orderBy)
                && Objects.equals(this.skip, getNvmfSubsystemsRequestBody.skip)
                && Objects.equals(this.where, getNvmfSubsystemsRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetNvmfSubsystemsRequestBody {\n");
