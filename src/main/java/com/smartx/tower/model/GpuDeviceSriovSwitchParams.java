...
public class GpuDeviceSriovSwitchParams
    ...
    public GpuDeviceSriovSwitchParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public GpuDeviceSriovSwitchParams data_ExplictlyNonNull() {
    ...
    public GpuDeviceSriovSwitchParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GpuDeviceSriovSwitchParams where_ExplictlyNonNull() {
