...
public class VmCreateVmFromTemplateParams {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cloudInit, clusterId, cpuCores, cpuSockets, description, diskOperate, firmware, folderId, guestOsType, ha, hostId, ioPolicy, isFullCopy, maxBandwidth, maxBandwidthPolicy, maxIops, maxIopsPolicy, memory, name, status, templateId, vcpu, vmNics);
  }
