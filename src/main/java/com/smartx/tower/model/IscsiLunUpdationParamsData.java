...
public class IscsiLunUpdationParamsData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assignedSize, name, allowedInitiators, bps, bpsMax, bpsMaxLength, bpsRd, bpsRdMax, bpsRdMaxLength, bpsWr, bpsWrMax, bpsWrMaxLength, iops, iopsMax, iopsMaxLength, iopsRd, iopsRdMax, iopsRdMaxLength, iopsWr, iopsWrMax, iopsWrMaxLength);
  }
