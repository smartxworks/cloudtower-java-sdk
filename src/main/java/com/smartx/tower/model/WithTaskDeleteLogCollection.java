...
public class WithTaskDeleteLogCollection
    ...
    public WithTaskDeleteLogCollection taskId_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_TASK_ID);
        return this;
    }

    public WithTaskDeleteLogCollection taskId_ExplictlyNonNull() {
    ...
    public WithTaskDeleteLogCollection data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public WithTaskDeleteLogCollection data_ExplictlyNonNull() {
