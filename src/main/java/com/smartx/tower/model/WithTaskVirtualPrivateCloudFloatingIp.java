...
public class WithTaskVirtualPrivateCloudFloatingIp
    ...
    public WithTaskVirtualPrivateCloudFloatingIp taskId_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_TASK_ID);
        return this;
    }

    public WithTaskVirtualPrivateCloudFloatingIp taskId_ExplictlyNonNull() {
    ...
    public WithTaskVirtualPrivateCloudFloatingIp data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public WithTaskVirtualPrivateCloudFloatingIp data_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        WithTaskVirtualPrivateCloudFloatingIp withTaskVirtualPrivateCloudFloatingIp =
                (WithTaskVirtualPrivateCloudFloatingIp) o;
