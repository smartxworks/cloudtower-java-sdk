...
public class MigrationVlanUpdationParams
    ...
    public MigrationVlanUpdationParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public MigrationVlanUpdationParams data_ExplictlyNonNull() {
    ...
    public MigrationVlanUpdationParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public MigrationVlanUpdationParams where_ExplictlyNonNull() {
