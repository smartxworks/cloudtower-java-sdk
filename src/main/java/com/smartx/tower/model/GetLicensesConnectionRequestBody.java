...
public class GetLicensesConnectionRequestBody
    ...
    public GetLicensesConnectionRequestBody() {}
    ...
    public GetLicensesConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetLicensesConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetLicensesConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetLicensesConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetLicensesConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetLicensesConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetLicensesConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetLicensesConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetLicensesConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetLicensesConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetLicensesConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetLicensesConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetLicensesConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetLicensesConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetLicensesConnectionRequestBody getLicensesConnectionRequestBody =
                (GetLicensesConnectionRequestBody) o;
        return Objects.equals(this.after, getLicensesConnectionRequestBody.after)
                && Objects.equals(this.before, getLicensesConnectionRequestBody.before)
                && Objects.equals(this.first, getLicensesConnectionRequestBody.first)
                && Objects.equals(this.last, getLicensesConnectionRequestBody.last)
                && Objects.equals(this.orderBy, getLicensesConnectionRequestBody.orderBy)
                && Objects.equals(this.skip, getLicensesConnectionRequestBody.skip)
                && Objects.equals(this.where, getLicensesConnectionRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetLicensesConnectionRequestBody {\n");
