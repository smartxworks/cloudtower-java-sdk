...
public class GetVsphereEsxiAccountsRequestBody
    ...
    public GetVsphereEsxiAccountsRequestBody() {}
    ...
    public GetVsphereEsxiAccountsRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetVsphereEsxiAccountsRequestBody after_ExplictlyNonNull() {
    ...
    public GetVsphereEsxiAccountsRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetVsphereEsxiAccountsRequestBody before_ExplictlyNonNull() {
    ...
    public GetVsphereEsxiAccountsRequestBody first(Integer first) {
    ...
    public GetVsphereEsxiAccountsRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetVsphereEsxiAccountsRequestBody first_ExplictlyNonNull() {
    ...
    public GetVsphereEsxiAccountsRequestBody last(Integer last) {
    ...
    public GetVsphereEsxiAccountsRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetVsphereEsxiAccountsRequestBody last_ExplictlyNonNull() {
    ...
    public GetVsphereEsxiAccountsRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetVsphereEsxiAccountsRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetVsphereEsxiAccountsRequestBody skip(Integer skip) {
    ...
    public GetVsphereEsxiAccountsRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetVsphereEsxiAccountsRequestBody skip_ExplictlyNonNull() {
    ...
    public GetVsphereEsxiAccountsRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetVsphereEsxiAccountsRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetVsphereEsxiAccountsRequestBody getVsphereEsxiAccountsRequestBody =
                (GetVsphereEsxiAccountsRequestBody) o;
        return Objects.equals(this.after, getVsphereEsxiAccountsRequestBody.after)
                && Objects.equals(this.before, getVsphereEsxiAccountsRequestBody.before)
                && Objects.equals(this.first, getVsphereEsxiAccountsRequestBody.first)
                && Objects.equals(this.last, getVsphereEsxiAccountsRequestBody.last)
                && Objects.equals(this.orderBy, getVsphereEsxiAccountsRequestBody.orderBy)
                && Objects.equals(this.skip, getVsphereEsxiAccountsRequestBody.skip)
                && Objects.equals(this.where, getVsphereEsxiAccountsRequestBody.where);
    }
