...
public class WithTaskDeleteSnapshotPlan
    ...
    public WithTaskDeleteSnapshotPlan() {}
    ...
    public WithTaskDeleteSnapshotPlan taskId_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_TASK_ID);
        return this;
    }

    public WithTaskDeleteSnapshotPlan taskId_ExplictlyNonNull() {
    ...
    public WithTaskDeleteSnapshotPlan data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public WithTaskDeleteSnapshotPlan data_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.taskId, withTaskDeleteSnapshotPlan.taskId)
