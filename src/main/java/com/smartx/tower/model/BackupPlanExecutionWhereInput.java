...
public class BackupPlanExecutionWhereInput {
  ...
  public static final String SERIALIZED_NAME_BACKUP_TARGET_EXECUTIONS_EVERY = "backup_target_executions_every";
  @SerializedName(SERIALIZED_NAME_BACKUP_TARGET_EXECUTIONS_EVERY)
  private BackupTargetExecutionWhereInput backupTargetExecutionsEvery;

  public static final String SERIALIZED_NAME_BACKUP_TARGET_EXECUTIONS_NONE = "backup_target_executions_none";
  @SerializedName(SERIALIZED_NAME_BACKUP_TARGET_EXECUTIONS_NONE)
  private BackupTargetExecutionWhereInput backupTargetExecutionsNone;

  public static final String SERIALIZED_NAME_BACKUP_TARGET_EXECUTIONS_SOME = "backup_target_executions_some";
  @SerializedName(SERIALIZED_NAME_BACKUP_TARGET_EXECUTIONS_SOME)
  private BackupTargetExecutionWhereInput backupTargetExecutionsSome;
  ...
  **/
  ...
  public BackupPlanExecutionWhereInput backupRestorePointsEvery(BackupRestorePointWhereInput backupRestorePointsEvery) {
  ...
  **/
  ...
  public BackupPlanExecutionWhereInput backupRestorePointsNone(BackupRestorePointWhereInput backupRestorePointsNone) {
  ...
  **/
  ...
  public BackupPlanExecutionWhereInput backupRestorePointsSome(BackupRestorePointWhereInput backupRestorePointsSome) {
  ...
  **/
  ...
  public BackupPlanExecutionWhereInput backupTargetExecutionsEvery(BackupTargetExecutionWhereInput backupTargetExecutionsEvery) {
    
    this.backupTargetExecutionsEvery = backupTargetExecutionsEvery;
    return this;
  }

   /**
   * Get backupTargetExecutionsEvery
   * @return backupTargetExecutionsEvery
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public BackupTargetExecutionWhereInput getBackupTargetExecutionsEvery() {
    return backupTargetExecutionsEvery;
  }


  public void setBackupTargetExecutionsEvery(BackupTargetExecutionWhereInput backupTargetExecutionsEvery) {
    this.backupTargetExecutionsEvery = backupTargetExecutionsEvery;
  }


  public BackupPlanExecutionWhereInput backupTargetExecutionsNone(BackupTargetExecutionWhereInput backupTargetExecutionsNone) {
    
    this.backupTargetExecutionsNone = backupTargetExecutionsNone;
    return this;
  }

   /**
   * Get backupTargetExecutionsNone
   * @return backupTargetExecutionsNone
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public BackupTargetExecutionWhereInput getBackupTargetExecutionsNone() {
    return backupTargetExecutionsNone;
  }


  public void setBackupTargetExecutionsNone(BackupTargetExecutionWhereInput backupTargetExecutionsNone) {
    this.backupTargetExecutionsNone = backupTargetExecutionsNone;
  }


  public BackupPlanExecutionWhereInput backupTargetExecutionsSome(BackupTargetExecutionWhereInput backupTargetExecutionsSome) {
    
    this.backupTargetExecutionsSome = backupTargetExecutionsSome;
    return this;
  }

   /**
   * Get backupTargetExecutionsSome
   * @return backupTargetExecutionsSome
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public BackupTargetExecutionWhereInput getBackupTargetExecutionsSome() {
    return backupTargetExecutionsSome;
  }


  public void setBackupTargetExecutionsSome(BackupTargetExecutionWhereInput backupTargetExecutionsSome) {
    this.backupTargetExecutionsSome = backupTargetExecutionsSome;
  }
  ...
  **/
  ...
  public BackupPlanExecutionWhereInput resourceVersionGt(Integer resourceVersionGt) {
  ...
  **/
  ...
  public BackupPlanExecutionWhereInput resourceVersionGte(Integer resourceVersionGte) {
  ...
  **/
  ...
  public BackupPlanExecutionWhereInput resourceVersionIn(List<Integer> resourceVersionIn) {
    
    this.resourceVersionIn = resourceVersionIn;
    return this;
  }

  public BackupPlanExecutionWhereInput addResourceVersionInItem(Integer resourceVersionInItem) {
  ...
  **/
  ...
  public BackupPlanExecutionWhereInput resourceVersionLt(Integer resourceVersionLt) {
  ...
  **/
  ...
  public BackupPlanExecutionWhereInput resourceVersionLte(Integer resourceVersionLte) {
  ...
  **/
  ...
  public BackupPlanExecutionWhereInput resourceVersionNot(Integer resourceVersionNot) {
  ...
  **/
  ...
  public BackupPlanExecutionWhereInput resourceVersionNotIn(List<Integer> resourceVersionNotIn) {
    
    this.resourceVersionNotIn = resourceVersionNotIn;
    return this;
  }

  public BackupPlanExecutionWhereInput addResourceVersionNotInItem(Integer resourceVersionNotInItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.AND, backupPlanExecutionWhereInput.AND) &&
        ...
        Objects.equals(this.backupRestorePointsEvery, backupPlanExecutionWhereInput.backupRestorePointsEvery) &&
        Objects.equals(this.backupRestorePointsNone, backupPlanExecutionWhereInput.backupRestorePointsNone) &&
        Objects.equals(this.backupRestorePointsSome, backupPlanExecutionWhereInput.backupRestorePointsSome) &&
        Objects.equals(this.backupTargetExecutionsEvery, backupPlanExecutionWhereInput.backupTargetExecutionsEvery) &&
        Objects.equals(this.backupTargetExecutionsNone, backupPlanExecutionWhereInput.backupTargetExecutionsNone) &&
        Objects.equals(this.backupTargetExecutionsSome, backupPlanExecutionWhereInput.backupTargetExecutionsSome) &&
        ...
        Objects.equals(this.resourceVersionGt, backupPlanExecutionWhereInput.resourceVersionGt) &&
        Objects.equals(this.resourceVersionGte, backupPlanExecutionWhereInput.resourceVersionGte) &&
        Objects.equals(this.resourceVersionIn, backupPlanExecutionWhereInput.resourceVersionIn) &&
        Objects.equals(this.resourceVersionLt, backupPlanExecutionWhereInput.resourceVersionLt) &&
        Objects.equals(this.resourceVersionLte, backupPlanExecutionWhereInput.resourceVersionLte) &&
        Objects.equals(this.resourceVersionNot, backupPlanExecutionWhereInput.resourceVersionNot) &&
        Objects.equals(this.resourceVersionNotIn, backupPlanExecutionWhereInput.resourceVersionNotIn) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(AND, backupPlan, backupRestorePointsEvery, backupRestorePointsNone, backupRestorePointsSome, backupTargetExecutionsEvery, backupTargetExecutionsNone, backupTargetExecutionsSome, duration, durationGt, durationGte, durationIn, durationLt, durationLte, durationNot, durationNotIn, entityAsyncStatus, entityAsyncStatusIn, entityAsyncStatusNot, entityAsyncStatusNotIn, executedAt, executedAtGt, executedAtGte, executedAtIn, executedAtLt, executedAtLte, executedAtNot, executedAtNotIn, id, idContains, idEndsWith, idGt, idGte, idIn, idLt, idLte, idNot, idNotContains, idNotEndsWith, idNotIn, idNotStartsWith, idStartsWith, localCreatedAt, localCreatedAtGt, localCreatedAtGte, localCreatedAtIn, localCreatedAtLt, localCreatedAtLte, localCreatedAtNot, localCreatedAtNotIn, localId, localIdContains, localIdEndsWith, localIdGt, localIdGte, localIdIn, localIdLt, localIdLte, localIdNot, localIdNotContains, localIdNotEndsWith, localIdNotIn, localIdNotStartsWith, localIdStartsWith, method, methodIn, methodNot, methodNotIn, NOT, OR, resourceVersionGt, resourceVersionGte, resourceVersionIn, resourceVersionLt, resourceVersionLte, resourceVersionNot, resourceVersionNotIn, status, statusIn, statusNot, statusNotIn, successJobCount, successJobCountGt, successJobCountGte, successJobCountIn, successJobCountLt, successJobCountLte, successJobCountNot, successJobCountNotIn, totalJobCount, totalJobCountGt, totalJobCountGte, totalJobCountIn, totalJobCountLt, totalJobCountLte, totalJobCountNot, totalJobCountNotIn, type, typeIn, typeNot, typeNotIn);
  }
  ...
  public String toString() {
    ...
    sb.append("    backupTargetExecutionsEvery: ").append(toIndentedString(backupTargetExecutionsEvery)).append("\n");
    sb.append("    backupTargetExecutionsNone: ").append(toIndentedString(backupTargetExecutionsNone)).append("\n");
    sb.append("    backupTargetExecutionsSome: ").append(toIndentedString(backupTargetExecutionsSome)).append("\n");
