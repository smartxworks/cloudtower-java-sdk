...
public class Task {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Task task = (Task) o;
    return Objects.equals(this.typename, task.typename) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(typename, args, cluster, description, errorCode, errorMessage, finishedAt, id, internal, key, localCreatedAt, progress, resourceId, resourceMutation, resourceRollbackError, resourceRollbackRetryCount, resourceRollbacked, resourceType, snapshot, startedAt, status, steps, type, user);
  }
