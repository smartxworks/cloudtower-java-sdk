...
public class GetSnmpTrapReceiversConnectionRequestBody
    ...
    public GetSnmpTrapReceiversConnectionRequestBody() {}
    ...
    public GetSnmpTrapReceiversConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetSnmpTrapReceiversConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetSnmpTrapReceiversConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetSnmpTrapReceiversConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetSnmpTrapReceiversConnectionRequestBody first(Integer first) {
    ...
    public GetSnmpTrapReceiversConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetSnmpTrapReceiversConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetSnmpTrapReceiversConnectionRequestBody last(Integer last) {
    ...
    public GetSnmpTrapReceiversConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetSnmpTrapReceiversConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetSnmpTrapReceiversConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetSnmpTrapReceiversConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetSnmpTrapReceiversConnectionRequestBody skip(Integer skip) {
    ...
    public GetSnmpTrapReceiversConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetSnmpTrapReceiversConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetSnmpTrapReceiversConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetSnmpTrapReceiversConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetSnmpTrapReceiversConnectionRequestBody getSnmpTrapReceiversConnectionRequestBody =
                (GetSnmpTrapReceiversConnectionRequestBody) o;
        return Objects.equals(this.after, getSnmpTrapReceiversConnectionRequestBody.after)
                && Objects.equals(this.before, getSnmpTrapReceiversConnectionRequestBody.before)
                && Objects.equals(this.first, getSnmpTrapReceiversConnectionRequestBody.first)
                && Objects.equals(this.last, getSnmpTrapReceiversConnectionRequestBody.last)
                && Objects.equals(this.orderBy, getSnmpTrapReceiversConnectionRequestBody.orderBy)
                && Objects.equals(this.skip, getSnmpTrapReceiversConnectionRequestBody.skip)
                && Objects.equals(this.where, getSnmpTrapReceiversConnectionRequestBody.where);
    }
