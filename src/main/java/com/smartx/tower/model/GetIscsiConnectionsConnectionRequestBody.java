...
public class GetIscsiConnectionsConnectionRequestBody
    ...
    public GetIscsiConnectionsConnectionRequestBody() {}
    ...
    public GetIscsiConnectionsConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetIscsiConnectionsConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetIscsiConnectionsConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetIscsiConnectionsConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetIscsiConnectionsConnectionRequestBody first(Integer first) {
    ...
    public GetIscsiConnectionsConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetIscsiConnectionsConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetIscsiConnectionsConnectionRequestBody last(Integer last) {
    ...
    public GetIscsiConnectionsConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetIscsiConnectionsConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetIscsiConnectionsConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetIscsiConnectionsConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetIscsiConnectionsConnectionRequestBody skip(Integer skip) {
    ...
    public GetIscsiConnectionsConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetIscsiConnectionsConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetIscsiConnectionsConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetIscsiConnectionsConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetIscsiConnectionsConnectionRequestBody getIscsiConnectionsConnectionRequestBody =
                (GetIscsiConnectionsConnectionRequestBody) o;
        return Objects.equals(this.after, getIscsiConnectionsConnectionRequestBody.after)
                && Objects.equals(this.before, getIscsiConnectionsConnectionRequestBody.before)
                && Objects.equals(this.first, getIscsiConnectionsConnectionRequestBody.first)
                && Objects.equals(this.last, getIscsiConnectionsConnectionRequestBody.last)
                && Objects.equals(this.orderBy, getIscsiConnectionsConnectionRequestBody.orderBy)
                && Objects.equals(this.skip, getIscsiConnectionsConnectionRequestBody.skip)
                && Objects.equals(this.where, getIscsiConnectionsConnectionRequestBody.where);
    }
