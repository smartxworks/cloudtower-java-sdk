...
public class GetPciDevicesRequestBody
    ...
    public GetPciDevicesRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetPciDevicesRequestBody after_ExplictlyNonNull() {
    ...
    public GetPciDevicesRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetPciDevicesRequestBody before_ExplictlyNonNull() {
    ...
    public GetPciDevicesRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetPciDevicesRequestBody first_ExplictlyNonNull() {
    ...
    public GetPciDevicesRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetPciDevicesRequestBody last_ExplictlyNonNull() {
    ...
    public GetPciDevicesRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetPciDevicesRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetPciDevicesRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetPciDevicesRequestBody skip_ExplictlyNonNull() {
    ...
    public GetPciDevicesRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetPciDevicesRequestBody where_ExplictlyNonNull() {
