...
import com.smartx.tower.model.GpuVmDetail;
...
public class GpuVmInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(vms, vgpuInstanceNum, userVgpuTypeName, userVgpuTypeId, userUsage, status, name, model, mdevSupportedTypes, localId, localCreatedAt, labels, isNvidiaVfsSupported, isNvidiaVfsEnabled, isNvidiaToolsReady, id, host, entityAsyncStatus, driverInfo, description, busLocation, brand, availableVgpusNum, assignedVgpusNum);
  }
