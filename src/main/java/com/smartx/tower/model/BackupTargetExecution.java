...
public class BackupTargetExecution {
  ...
  **/
  ...
  public BackupTargetExecution readBytes(Double readBytes) {
  ...
  **/
  ...
  public BackupTargetExecution totalBytes(Double totalBytes) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backupGroup, backupPlanExecution, backupRestorePoint, clusterLocalId, duration, entityAsyncStatus, executedAt, id, localId, parentBackup, readBytes, status, totalBytes, type, vm, vmLocalId, vmName);
  }
