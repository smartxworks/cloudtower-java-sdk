...
public class VmCreateVmFromContentLibraryTemplateBatchVmParams {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gpuDevices, vmCreateVmFromContentLibraryTemplateBatchVmParams.gpuDevices) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gpuDevices, cloudInit, isFullCopy, maxBandwidthPolicy, maxBandwidthUnit, maxBandwidth, maxIopsPolicy, maxIops, vcpu, status, firmware, ha, pciNics, vmPlacementGroup, vmNics, diskOperate, memoryUnit, memory, cpuCores, cpuSockets, guestOsType, folderId, description, name, hostId, clusterId);
  }
