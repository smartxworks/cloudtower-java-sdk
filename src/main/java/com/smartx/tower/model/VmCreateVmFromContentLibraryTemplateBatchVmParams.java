...
public class VmCreateVmFromContentLibraryTemplateBatchVmParams {
  ...
  **/
  ...
  public VmCreateVmFromContentLibraryTemplateBatchVmParams ioPolicy(VmDiskIoPolicy ioPolicy) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.owner, vmCreateVmFromContentLibraryTemplateBatchVmParams.owner) &&
        ...
        Objects.equals(this.ioPolicy, vmCreateVmFromContentLibraryTemplateBatchVmParams.ioPolicy) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(owner, gpuDevices, cloudInit, isFullCopy, maxBandwidthPolicy, maxBandwidthUnit, maxBandwidth, maxIopsPolicy, maxIops, ioPolicy, vcpu, status, firmware, ha, pciNics, vmPlacementGroup, vmNics, diskOperate, memoryUnit, memory, cpuCores, cpuSockets, guestOsType, folderId, description, name, hostId, clusterId);
  }
