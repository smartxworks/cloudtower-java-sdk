...
public class GetHostMetricInput
    ...
    public GetHostMetricInput range_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_RANGE);
        return this;
    }

    public GetHostMetricInput range_ExplictlyNonNull() {
    ...
    public GetHostMetricInput hosts_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_HOSTS);
        return this;
    }

    public GetHostMetricInput hosts_ExplictlyNonNull() {
    ...
    public GetHostMetricInput metrics_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_METRICS);
        return this;
    }

    public GetHostMetricInput metrics_ExplictlyNonNull() {
