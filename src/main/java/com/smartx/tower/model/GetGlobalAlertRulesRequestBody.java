...
public class GetGlobalAlertRulesRequestBody
    ...
    public GetGlobalAlertRulesRequestBody() {}

    public GetGlobalAlertRulesRequestBody after(String after) {
    ...
    public GetGlobalAlertRulesRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetGlobalAlertRulesRequestBody after_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesRequestBody before(String before) {
    ...
    public GetGlobalAlertRulesRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetGlobalAlertRulesRequestBody before_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesRequestBody first(Integer first) {
    ...
    public GetGlobalAlertRulesRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetGlobalAlertRulesRequestBody first_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesRequestBody last(Integer last) {
    ...
    public GetGlobalAlertRulesRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetGlobalAlertRulesRequestBody last_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesRequestBody orderBy(GlobalAlertRuleOrderByInput orderBy) {
    ...
    public GetGlobalAlertRulesRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetGlobalAlertRulesRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesRequestBody skip(Integer skip) {
    ...
    public GetGlobalAlertRulesRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetGlobalAlertRulesRequestBody skip_ExplictlyNonNull() {
    ...
    public GetGlobalAlertRulesRequestBody where(GlobalAlertRuleWhereInput where) {
    ...
    public GetGlobalAlertRulesRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetGlobalAlertRulesRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetGlobalAlertRulesRequestBody getGlobalAlertRulesRequestBody =
                (GetGlobalAlertRulesRequestBody) o;
        return Objects.equals(this.after, getGlobalAlertRulesRequestBody.after)
                && Objects.equals(this.before, getGlobalAlertRulesRequestBody.before)
                && Objects.equals(this.first, getGlobalAlertRulesRequestBody.first)
                && Objects.equals(this.last, getGlobalAlertRulesRequestBody.last)
                && Objects.equals(this.orderBy, getGlobalAlertRulesRequestBody.orderBy)
                && Objects.equals(this.skip, getGlobalAlertRulesRequestBody.skip)
                && Objects.equals(this.where, getGlobalAlertRulesRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetGlobalAlertRulesRequestBody {\n");
