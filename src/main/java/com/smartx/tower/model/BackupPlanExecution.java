...
public class BackupPlanExecution {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backupPlan, backupRestorePoints, backupTargetExecutions, duration, entityAsyncStatus, executedAt, id, localCreatedAt, localId, method, status, successJobCount, totalJobCount, type);
  }
