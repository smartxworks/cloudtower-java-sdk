...
public class BackupPlanExecution {
  ...
  public static final String SERIALIZED_NAME_BACKUP_TARGET_EXECUTIONS = "backup_target_executions";
  @SerializedName(SERIALIZED_NAME_BACKUP_TARGET_EXECUTIONS)
  private List<NestedBackupTargetExecution> backupTargetExecutions = null;
  ...
  **/
  ...
  public BackupPlanExecution backupRestorePoints(List<NestedBackupRestorePoint> backupRestorePoints) {
    
    this.backupRestorePoints = backupRestorePoints;
    return this;
  }

  public BackupPlanExecution addBackupRestorePointsItem(NestedBackupRestorePoint backupRestorePointsItem) {
  ...
  **/
  ...
  public BackupPlanExecution backupTargetExecutions(List<NestedBackupTargetExecution> backupTargetExecutions) {
    
    this.backupTargetExecutions = backupTargetExecutions;
    return this;
  }

  public BackupPlanExecution addBackupTargetExecutionsItem(NestedBackupTargetExecution backupTargetExecutionsItem) {
    if (this.backupTargetExecutions == null) {
      this.backupTargetExecutions = new ArrayList<NestedBackupTargetExecution>();
    }
    this.backupTargetExecutions.add(backupTargetExecutionsItem);
    return this;
  }

   /**
   * Get backupTargetExecutions
   * @return backupTargetExecutions
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public List<NestedBackupTargetExecution> getBackupTargetExecutions() {
    return backupTargetExecutions;
  }


  public void setBackupTargetExecutions(List<NestedBackupTargetExecution> backupTargetExecutions) {
    this.backupTargetExecutions = backupTargetExecutions;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backupPlan, backupPlanExecution.backupPlan) &&
        Objects.equals(this.backupRestorePoints, backupPlanExecution.backupRestorePoints) &&
        Objects.equals(this.backupTargetExecutions, backupPlanExecution.backupTargetExecutions) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backupPlan, backupRestorePoints, backupTargetExecutions, duration, entityAsyncStatus, executedAt, id, localCreatedAt, localId, method, state, status, successJobCount, totalJobCount, type);
  }
  ...
  public String toString() {
    ...
    sb.append("    backupTargetExecutions: ").append(toIndentedString(backupTargetExecutions)).append("\n");
