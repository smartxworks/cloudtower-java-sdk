...
public class ClusterUpdationParams
    ...
    public ClusterUpdationParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public ClusterUpdationParams data_ExplictlyNonNull() {
    ...
    public ClusterUpdationParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public ClusterUpdationParams where_ExplictlyNonNull() {
