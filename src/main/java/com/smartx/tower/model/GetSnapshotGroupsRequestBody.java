...
public class GetSnapshotGroupsRequestBody
    ...
    public GetSnapshotGroupsRequestBody() {}
    ...
    public GetSnapshotGroupsRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetSnapshotGroupsRequestBody after_ExplictlyNonNull() {
    ...
    public GetSnapshotGroupsRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetSnapshotGroupsRequestBody before_ExplictlyNonNull() {
    ...
    public GetSnapshotGroupsRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetSnapshotGroupsRequestBody first_ExplictlyNonNull() {
    ...
    public GetSnapshotGroupsRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetSnapshotGroupsRequestBody last_ExplictlyNonNull() {
    ...
    public GetSnapshotGroupsRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetSnapshotGroupsRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetSnapshotGroupsRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetSnapshotGroupsRequestBody skip_ExplictlyNonNull() {
    ...
    public GetSnapshotGroupsRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetSnapshotGroupsRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetSnapshotGroupsRequestBody getSnapshotGroupsRequestBody =
                (GetSnapshotGroupsRequestBody) o;
        return Objects.equals(this.after, getSnapshotGroupsRequestBody.after)
                && Objects.equals(this.before, getSnapshotGroupsRequestBody.before)
                && Objects.equals(this.first, getSnapshotGroupsRequestBody.first)
                && Objects.equals(this.last, getSnapshotGroupsRequestBody.last)
                && Objects.equals(this.orderBy, getSnapshotGroupsRequestBody.orderBy)
                && Objects.equals(this.skip, getSnapshotGroupsRequestBody.skip)
                && Objects.equals(this.where, getSnapshotGroupsRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetSnapshotGroupsRequestBody {\n");
