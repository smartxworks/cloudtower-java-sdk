...
public class OrganizationUpdationParams
    ...
    public OrganizationUpdationParams() {}
    ...
    public OrganizationUpdationParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public OrganizationUpdationParams data_ExplictlyNonNull() {
    ...
    public OrganizationUpdationParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public OrganizationUpdationParams where_ExplictlyNonNull() {
