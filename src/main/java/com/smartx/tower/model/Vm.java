...
public class Vm {
  ...
  private NestedBackupService installedBackupService;
  ...
  **/
  ...
  public Vm installedBackupService(NestedBackupService installedBackupService) {
  ...
  **/
  ...
  public NestedBackupService getInstalledBackupService() {
    return installedBackupService;
  }


  public void setInstalledBackupService(NestedBackupService installedBackupService) {
    this.installedBackupService = installedBackupService;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backupPlans, vm.backupPlans) &&
        ...
        Objects.equals(this.installedBackupService, vm.installedBackupService) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backupPlans, clockOffset, cloudInitSupported, cluster, cpu, cpuModel, cpuUsage, deletedAt, description, dnsServers, entityAsyncStatus, entityFilterResults, firmware, folder, guestCpuModel, guestOsType, guestSizeUsage, guestUsedSize, ha, host, hostname, id, inRecycleBin, installedBackupService, internal, ioPolicy, ips, isolationPolicy, kernelInfo, labels, lastShutdownTime, localCreatedAt, localId, logicalSizeBytes, maxBandwidth, maxBandwidthPolicy, maxIops, maxIopsPolicy, memory, memoryUsage, name, nestedVirtualization, nodeIp, originalName, os, outUninstallUsb, _protected, provisionedSize, size, snapshotPlan, snapshots, status, uniqueSize, usbDevices, vcpu, videoType, vmDisks, vmNics, vmPlacementGroup, vmToolsStatus, vmToolsVersion, vmUsage, winOpt);
  }
