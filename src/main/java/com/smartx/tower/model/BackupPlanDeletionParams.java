...
public class BackupPlanDeletionParams
    ...
    public BackupPlanDeletionParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public BackupPlanDeletionParams data_ExplictlyNonNull() {
    ...
    public BackupPlanDeletionParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public BackupPlanDeletionParams where_ExplictlyNonNull() {
