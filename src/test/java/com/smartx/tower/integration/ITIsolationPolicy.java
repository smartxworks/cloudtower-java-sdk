...
public class ITIsolationPolicy extends ITBase {
    ...
    public void getIsolationPolicies(String payload) {
        try {
            ...
            GetIsolationPoliciesRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetIsolationPoliciesRequestBody>() {}.getType());
    ...
    public void getIsolationPoliciesConnection(String payload) {
        try {
            // parse params from json payload
            GetIsolationPoliciesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    GetIsolationPoliciesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
