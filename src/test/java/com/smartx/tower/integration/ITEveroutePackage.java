...
public class ITEveroutePackage extends ITBase {
    ...
    public void getEveroutePackages(String payload) {
        try {
            ...
            GetEveroutePackagesRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetEveroutePackagesRequestBody>() {}.getType());
    ...
    public void getEveroutePackagesConnection(String payload) {
        try {
            // parse params from json payload
            GetEveroutePackagesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetEveroutePackagesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
