...
public class ITUsbDevice extends ITBase {
    ...
    public void getUsbDevices(String payload) {
        try {
            ...
            GetUsbDevicesRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetUsbDevicesRequestBody>() {}.getType());
    ...
    public void getUsbDevicesConnection(String payload) {
        try {
            // parse params from json payload
            GetUsbDevicesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetUsbDevicesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void mountUsbDevice(String payload) {
        try {
            // parse params from json payload
            UsbDeviceMountParams params =
                    gson.fromJson(payload, new TypeToken<UsbDeviceMountParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void unmountUsbDevice(String payload) {
        try {
            // parse params from json payload
            UsbDeviceUnmountParams params =
                    gson.fromJson(payload, new TypeToken<UsbDeviceUnmountParams>() {}.getType());
            // do some modify to params(optional)
