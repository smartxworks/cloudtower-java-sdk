...
public class ITReportTemplate extends ITBase {
    ...
    public void createReportTemplate(String payload) {
        try {
            ...
            List<ReportTemplateCreationParams> params =
                    gson.fromJson(
                            payload,
                            new TypeToken<List<ReportTemplateCreationParams>>() {}.getType());
    ...
    public void deleteReportTemplate(String payload) {
        try {
            // parse params from json payload
            ReportTemplateDeletionParams params =
                    gson.fromJson(
                            payload, new TypeToken<ReportTemplateDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void generateFromReportTemplate(String payload) {
        try {
            // parse params from json payload
            ReporteTemplateGenerationParams params =
                    gson.fromJson(
                            payload, new TypeToken<ReporteTemplateGenerationParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getReportTemplates(String payload) {
        try {
            // parse params from json payload
            GetReportTemplatesRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetReportTemplatesRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getReportTemplatesConnection(String payload) {
        try {
            // parse params from json payload
            GetReportTemplatesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetReportTemplatesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateReportTemplate(String payload) {
        try {
            // parse params from json payload
            ReportTemplateUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<ReportTemplateUpdationParams>() {}.getType());
            // do some modify to params(optional)
