...
public class ITView extends ITBase {
    ...
    public void createView(String payload) {
        try {
            ...
            List<ViewCreationParams> params =
                    gson.fromJson(payload, new TypeToken<List<ViewCreationParams>>() {}.getType());
    ...
    public void deleteView(String payload) {
        try {
            // parse params from json payload
            ViewDeletionParams params =
                    gson.fromJson(payload, new TypeToken<ViewDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getViews(String payload) {
        try {
            // parse params from json payload
            GetViewsRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetViewsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getViewsConnection(String payload) {
        try {
            // parse params from json payload
            GetViewsConnectionRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetViewsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateView(String payload) {
        try {
            // parse params from json payload
            ViewUpdationParams params =
                    gson.fromJson(payload, new TypeToken<ViewUpdationParams>() {}.getType());
            // do some modify to params(optional)
