...
public class ITConsistencyGroup extends ITBase {
    ...
    public void createConsistencyGroup(String payload) {
        try {
            ...
            List<ConsistencyGroupCreationParams> params =
                    gson.fromJson(
                            payload,
                            new TypeToken<List<ConsistencyGroupCreationParams>>() {}.getType());
    ...
    public void deleteConsistencyGroup(String payload) {
        try {
            // parse params from json payload
            ConsistencyGroupDeletionParams params =
                    gson.fromJson(
                            payload, new TypeToken<ConsistencyGroupDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getConsistencyGroups(String payload) {
        try {
            // parse params from json payload
            GetConsistencyGroupsRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetConsistencyGroupsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getConsistencyGroupsConnection(String payload) {
        try {
            // parse params from json payload
            GetConsistencyGroupsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    GetConsistencyGroupsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateConsistencyGroup(String payload) {
        try {
            // parse params from json payload
            ConsistencyGroupUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<ConsistencyGroupUpdationParams>() {}.getType());
            // do some modify to params(optional)
