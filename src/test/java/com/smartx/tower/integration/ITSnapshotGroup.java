...
public class ITSnapshotGroup extends ITBase {
    ...
    public void cloneSnapshotGroup(String payload) {
        try {
            ...
            List<SnapshotGroupCloneParams> params =
                    gson.fromJson(
                            payload, new TypeToken<List<SnapshotGroupCloneParams>>() {}.getType());
    ...
    public void deleteSnapshotGroup(String payload) {
        try {
            // parse params from json payload
            SnapshotGroupDeletionParams params =
                    gson.fromJson(
                            payload, new TypeToken<SnapshotGroupDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getSnapshotGroups(String payload) {
        try {
            // parse params from json payload
            GetSnapshotGroupsRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetSnapshotGroupsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getSnapshotGroupsConnection(String payload) {
        try {
            // parse params from json payload
            GetSnapshotGroupsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetSnapshotGroupsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void keepSnapshotGroup(String payload) {
        try {
            // parse params from json payload
            SnapshotGroupKeepParams params =
                    gson.fromJson(payload, new TypeToken<SnapshotGroupKeepParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void rollbackSnapshotGroup(String payload) {
        try {
            // parse params from json payload
            SnapshotGroupRollbackParams params =
                    gson.fromJson(
                            payload, new TypeToken<SnapshotGroupRollbackParams>() {}.getType());
            // do some modify to params(optional)
