...
public class ITVsphereEsxiAccount extends ITBase {
    ...
    public void getVsphereEsxiAccounts(String payload) {
        try {
            ...
            GetVsphereEsxiAccountsRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetVsphereEsxiAccountsRequestBody>() {}.getType());
    ...
    public void getVsphereEsxiAccountsConnection(String payload) {
        try {
            // parse params from json payload
            GetVsphereEsxiAccountsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    GetVsphereEsxiAccountsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
