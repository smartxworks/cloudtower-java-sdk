...
public class ITNamespaceGroup extends ITBase {
    ...
    public void createNamespaceGroup(String payload) {
        try {
            ...
            List<NamespaceGroupCreationParams> params =
                    gson.fromJson(
                            payload,
                            new TypeToken<List<NamespaceGroupCreationParams>>() {}.getType());
    ...
    public void deleteNamespaceGroup(String payload) {
        try {
            // parse params from json payload
            NamespaceGroupDeletionParams params =
                    gson.fromJson(
                            payload, new TypeToken<NamespaceGroupDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getNamespaceGroups(String payload) {
        try {
            // parse params from json payload
            GetNamespaceGroupsRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetNamespaceGroupsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getNamespaceGroupsConnection(String payload) {
        try {
            // parse params from json payload
            GetNamespaceGroupsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetNamespaceGroupsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateNamespaceGroup(String payload) {
        try {
            // parse params from json payload
            NamespaceGroupUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<NamespaceGroupUpdationParams>() {}.getType());
            // do some modify to params(optional)
