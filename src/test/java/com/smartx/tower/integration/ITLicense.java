...
public class ITLicense extends ITBase {
    ...
    public void getLicenses(String payload) {
        try {
            ...
            GetLicensesRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetLicensesRequestBody>() {}.getType());
    ...
    public void getLicensesConnection(String payload) {
        try {
            // parse params from json payload
            GetLicensesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetLicensesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateDeploy(String payload) {
        try {
            // parse params from json payload
            LicenseUpdationParams params =
                    gson.fromJson(payload, new TypeToken<LicenseUpdationParams>() {}.getType());
            // do some modify to params(optional)
