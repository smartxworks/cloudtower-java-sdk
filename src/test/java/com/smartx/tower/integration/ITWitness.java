...
public class ITWitness extends ITBase {
    ...
    public void getWitnesses(String payload) {
        try {
            ...
            GetWitnessesRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetWitnessesRequestBody>() {}.getType());
            // do some modify to params(optional)
            List<Witness> result = api.getWitnesses(params);
    ...
    public void getWitnessesConnection(String payload) {
        try {
            // parse params from json payload
            GetWitnessesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetWitnessesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
            WitnessConnection result = api.getWitnessesConnection(params);
