...
public class ITGlobalSettings extends ITBase {
    ...
    public void createClusterRecycleBinSetting(String payload) {
        try {
            ...
            ClusterRecycleBinCreationParams params =
                    gson.fromJson(
                            payload, new TypeToken<ClusterRecycleBinCreationParams>() {}.getType());
    ...
    public void deleteClusterRecycleBinSetting(String payload) {
        try {
            // parse params from json payload
            ClusterRecycleBinDeletionParams params =
                    gson.fromJson(
                            payload, new TypeToken<ClusterRecycleBinDeletionParams>() {}.getType());
            // do some modify to params(optional)
            List<WithTaskDeleteClusterRecycleBin> result =
                    api.deleteClusterRecycleBinSetting(params);
    ...
    public void getGlobalSettingses(String payload) {
        try {
            // parse params from json payload
            GetGlobalSettingsesRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetGlobalSettingsesRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getGlobalSettingsesConnection(String payload) {
        try {
            // parse params from json payload
            GetGlobalSettingsesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetGlobalSettingsesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateClusterRecycleBinSetting(String payload) {
        try {
            // parse params from json payload
            ClusterRecycleBinUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<ClusterRecycleBinUpdationParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateGlobalRecycleBinSetting(String payload) {
        try {
            // parse params from json payload
            GlobalRecycleBinUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<GlobalRecycleBinUpdationParams>() {}.getType());
            // do some modify to params(optional)
