...
public class ITSnmpTransport extends ITBase {
    ...
    public void createSnmpTransport(String payload) {
        try {
            ...
            List<SnmpTransportCreationParams> params =
                    gson.fromJson(
                            payload,
                            new TypeToken<List<SnmpTransportCreationParams>>() {}.getType());
    ...
    public void deleteSnmpTransport(String payload) {
        try {
            // parse params from json payload
            SnmpTransportDeletionParams params =
                    gson.fromJson(
                            payload, new TypeToken<SnmpTransportDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getSnmpTransports(String payload) {
        try {
            // parse params from json payload
            GetSnmpTransportsRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetSnmpTransportsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getSnmpTransportsConnection(String payload) {
        try {
            // parse params from json payload
            GetSnmpTransportsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetSnmpTransportsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateSnmpTransport(String payload) {
        try {
            // parse params from json payload
            SnmpTransportUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<SnmpTransportUpdationParams>() {}.getType());
            // do some modify to params(optional)
