...
public class ITSnapshotPlanTask extends ITBase {
    ...
    public void getSnapshotPlanTasks(String payload) {
        try {
            ...
            GetSnapshotPlanTasksRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetSnapshotPlanTasksRequestBody>() {}.getType());
    ...
    public void getSnapshotPlanTasksConnection(String payload) {
        try {
            // parse params from json payload
            GetSnapshotPlanTasksConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    GetSnapshotPlanTasksConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
