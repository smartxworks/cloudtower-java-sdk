...
public class ITElfImage extends ITBase {
    ...
    public void deleteElfImage(String payload) {
        try {
            // parse params from json payload
            ElfImageDeletionParams params =
                    gson.fromJson(payload, new TypeToken<ElfImageDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getElfImages(String payload) {
        try {
            // parse params from json payload
            GetElfImagesRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetElfImagesRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getElfImagesConnection(String payload) {
        try {
            // parse params from json payload
            GetElfImagesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetElfImagesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateElfImage(String payload) {
        try {
            // parse params from json payload
            ElfImageUpdationParams params =
                    gson.fromJson(payload, new TypeToken<ElfImageUpdationParams>() {}.getType());
            // do some modify to params(optional)
