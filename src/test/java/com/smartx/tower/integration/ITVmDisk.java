...
public class ITVmDisk extends ITBase {
    ...
    public void getVmDisks(String payload) {
        try {
            ...
            GetVmDisksRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetVmDisksRequestBody>() {}.getType());
    ...
    public void getVmDisksConnection(String payload) {
        try {
            // parse params from json payload
            GetVmDisksConnectionRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetVmDisksConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
