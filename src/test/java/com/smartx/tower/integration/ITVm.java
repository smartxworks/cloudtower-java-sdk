...
public class ITVm extends ITBase {
        ...
        try {
            ...
            params.add(
                    new VmCreationParams()
                            ...
                            .addVmNicsItem(
                                    new VmNicParams().connectVlanId(vlan.getId()).localId(""))
                            .name("tower-sdk-test-create-vm" + System.currentTimeMillis())
                            .cpuCores(1)
                            .cpuSockets(1)
                            .memory(4294967296L)
                            .ha(true)
                            ...
                            .vmDisks(
                                    new VmDiskParams()
                                            .addMountCdRomsItem(
                                                    new VmCdRomParams().boot(1).index(1))));
            ...
            waitForTaskSucceed(
                    api.deleteVm(new VmDeleteParams().where(new VmWhereInput().id(vm.getId())))
                            .get(0)
                            .getTaskId());
    ...
    public void createStoppedVm()
        ...
        params.add(
                new VmCreationParams()
                        .name("tower-sdk-test-stopped-vm" + System.currentTimeMillis())
                        .cpuCores(1)
                        .cpuSockets(1)
                        .memory(4294967296L)
                        .ha(true)
    ...
    public void removeStoppedVm()
        ...
        if (vm.getStatus() == VmStatus.RUNNING) {
            waitForTaskSucceed(
                    api.shutDownVm(new VmOperateParams().where(new VmWhereInput().id(vm.getId())))
                            .get(0)
                            .getTaskId());
        }
        VmDeleteParams params =
                new VmDeleteParams().where(new VmWhereInput().id(stoppedVm.getId()));
        ;
    ...
    @Test(
            dataProvider = "vmPayload",
            groups = {"need_stopped_vm"})
    public void cloneVm(String payload)
            throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
                    NoSuchMethodException, SecurityException {
        try {
            // parse params from json payload
            List<VmCloneParams> params =
                    gson.fromJson(payload, new TypeToken<List<VmCloneParams>>() {}.getType());
            params.get(0)
                    .srcVmId(stoppedVm.getId())
                    .clusterId(cluster.getId())
            ...
            waitForTaskSucceed(
                    api.deleteVm(
                                    new VmDeleteParams()
                                            .where(new VmWhereInput().id(clonedVm.getId())))
                            .get(0)
                            .getTaskId());
        } catch (ApiException e) {
            LOGGER.error(e.getResponseBody());
    ...
    public void startVm(String payload) {
        try {
            // parse params from json payload
            VmStartParams params =
                    gson.fromJson(payload, new TypeToken<VmStartParams>() {}.getType());
    ...
    public void updateVm(String payload) {
        try {
            // parse params from json payload
            VmUpdateParams params =
                    gson.fromJson(payload, new TypeToken<VmUpdateParams>() {}.getType());
            params.where(new VmWhereInput().id(stoppedVm.getId()));
            // do some modify to params(optional)
                                                    ...
                                                    new HostWhereInput()
                                                            .idNot(
                                                                    vmhost != null
                                                                            ...
                                                                            : null)
                                                            .cluster(
                                                                    new ClusterWhereInput()
                                                                            .id(cluster.getId()))))
                            .get(0);
            // parse params from json payload
            VmMigrateParams params =
                    gson.fromJson(payload, new TypeToken<VmMigrateParams>() {}.getType());
            params.where(new VmWhereInput().id(stoppedVm.getId()))
                    .data(new VmStartParamsData().hostId(host.getId()));
            // do some modify to params(optional)
    ...
    public void createRunningVm()
        ...
        params.add(
                new VmCreationParams()
                        .name("tower-sdk-test-running-vm" + System.currentTimeMillis())
                        .cpuCores(1)
                        .cpuSockets(1)
                        .memory(4294967296L)
                        .ha(true)
    ...
    public void removeRunningVm()
        ...
        VmDeleteParams params =
                new VmDeleteParams().where(new VmWhereInput().id(runningVM.getId()));
        waitForTaskSucceed(api.deleteVm(params).get(0).getTaskId());
        runningVM = null;
    }
    ...
    @Test(
            dataProvider = "vmPayload",
            groups = {"need_running_vm"})
    public void restartVm(String payload) {
        try {
            // parse params from json payload
            VmOperateParams params =
                    gson.fromJson(payload, new TypeToken<VmOperateParams>() {}.getType());
    ...
    public void getVms(String payload) {
        try {
            // parse params from json payload
            GetVmsRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetVmsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getVmsConnection(String payload) {
        try {
            // parse params from json payload
            GetVmsConnectionRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetVmsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void installVmtools(String payload) {
        try {
            // parse params from json payload
            InstallVmtoolsParams params =
                    gson.fromJson(payload, new TypeToken<InstallVmtoolsParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void OperatingVmCdRom()
            throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
                    NoSuchMethodException, SecurityException {
        try {
            // parse params from json payload
            VmAddCdRomParams addParams =
                    new VmAddCdRomParams()
                            .where(new VmWhereInput().id(stoppedVm.getId()))
                            .data(
                                    new VmAddCdRomParamsData()
                                            .addVmCdRomsItem(new VmCdRomParams().boot(2).index(2)));
            // do some modify to params(optional)
            ...
            VmRemoveCdRomParams removeParams =
                    new VmRemoveCdRomParams()
                            .where(new VmWhereInput().id(stoppedVm.getId()))
    ...
    @Test(groups = {"need_stopped_vm"})
    public void addAndUpdateAndRemoveVmDisk()
            throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
                    NoSuchMethodException, SecurityException {
        try {
            // parse params from json payload
            VmAddDiskParams addParams =
                    new VmAddDiskParams()
                            .where(new VmWhereInput().id(stoppedVm.getId()))
                            .data(
                                    new VmAddDiskParamsData()
                                            .vmDisks(
                                                                                    ...
                                                                                    new MountNewCreateDisksParamsVmVolume()
                                                                                            .elfStoragePolicy(
                                                                                                    VmVolumeElfStoragePolicyType
                                                                                                            ._2_THIN_PROVISION)
                                                                                            .name(
                                                                                                    "tower-sdk-test-vm-operate-disk-volume"
                                                                                                            + System
                                                                                                                    .currentTimeMillis())
                                                                                            .size(
                                                                                                    1073741824L)))));
            ...
            VmExpandVmDiskParams expandParams =
                    new VmExpandVmDiskParams()
                            .where(
                                    new VmDiskWhereInput()
                                            .vm(new VmWhereInput().id(stoppedVm.getId()))
                                            .type(VmDiskType.DISK))
                            .size(1073741824L * 2);
            ...
            stoppedVm =
                    api.getVms(
                                    new GetVmsRequestBody()
                                            .where(new VmWhereInput().id(stoppedVm.getId())))
                            .get(0);
            VmUpdateDiskParams updateParams =
                    new VmUpdateDiskParams()
                            .where(new VmWhereInput().id(stoppedVm.getId()))
                            .data(
                                    new VmUpdateDiskParamsData()
                                            .bus(Bus.SCSI)
                                            .vmDiskId(
                                                    addResult
                                                            .get(0)
            ...
            VmRemoveDiskParams removeParams =
                    new VmRemoveDiskParams()
                            .where(new VmWhereInput().id(stoppedVm.getId()))
                            .data(
                                    new VmRemoveDiskParamsData()
                                            .addDiskIdsItem(
                                                    addResult
                                                            .get(0)
                                                            .getData()
    ...
    @Test(groups = {"need_stopped_vm"})
    public void addAndUpdateAndRemoveVmNic()
            throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
                    NoSuchMethodException, SecurityException {
        try {
            Vlan vlan = getData("defaultVlan", Vlan.class);
            ...
            // parse params from json payload
            VmAddNicParams addParams =
                    new VmAddNicParams()
                            .where(new VmWhereInput().id(stoppedVm.getId()))
                            .data(
                                    new VmAddNicParamsData()
                                            .addVmNicsItem(
                                                    new VmNicParams().connectVlanId(vlan.getId())));
            // do some modify to params(optional)
            List<WithTaskVm> addResult = api.addVmNic(addParams);
            waitForTaskSucceed(addResult.get(0).getTaskId());
            assertThat(addResult).as("check result of addVmNic").isNotNull();
            VmUpdateNicParams updateParams =
                    new VmUpdateNicParams()
                            .where(new VmWhereInput().id(stoppedVm.getId()))
            ...
            VmRemoveNicParams removeParams =
                    new VmRemoveNicParams()
                            .where(new VmWhereInput().id(stoppedVm.getId()))
    ...
    @Test(groups = {"need_stopped_vm"})
    public void OperateVmRecycleBin()
            throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
                    NoSuchMethodException, SecurityException {
        try {
            ...
            GlobalSettings settings =
                    settingApi.getGlobalSettingses(new GetGlobalSettingsesRequestBody()).get(0);
            Boolean isRecycleBinEnabled = settings.getVmRecycleBin().getEnabled();
            if (!isRecycleBinEnabled) {
                GlobalSettings updatingSetting =
                        settingApi
                                .updateGlobalRecycleBinSetting(
                                        new GlobalRecycleBinUpdationParams()
                                                .enabled(true)
                                                .retain(30))
                                .getData();
                waitForResourceUpdationToTargetValue(
                        new GetGlobalSettingsesRequestBody()
                                .where(new GlobalSettingsWhereInput().id(updatingSetting.getId())),
                        settingApi,
                        GlobalSettingsApi.class.getDeclaredMethod(
                                "getGlobalSettingses",
                                GetGlobalSettingsesRequestBody.class,
                                String.class),
                        new TypeToken<List<GlobalSettings>>() {}.getClass(),
                        GetGlobalSettingsesRequestBody.class,
                        methods,
                        true);
            }
            VmOperateParams params =
                    new VmOperateParams().where(new VmWhereInput().id(stoppedVm.getId()));
            // do some modify to params(optional)
                ...
                GlobalSettings updatingSetting =
                        settingApi
                                .updateGlobalRecycleBinSetting(
                                        new GlobalRecycleBinUpdationParams()
                                                .enabled(false)
                                                .retain(settings.getVmRecycleBin().getRetain()))
                                .getData();
