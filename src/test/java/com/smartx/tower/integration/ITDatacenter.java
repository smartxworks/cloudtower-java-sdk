...
public class ITDatacenter extends ITBase {
    ...
    public void createDatacenter(String payload) {
        try {
            ...
            List<DatacenterCreationParams> params =
                    gson.fromJson(
                            payload, new TypeToken<List<DatacenterCreationParams>>() {}.getType());
            // do some modify to params(optional)
            List<WithTaskDatacenter> result = api.createDatacenter(params);
    ...
    public void deleteDatacenter(String payload) {
        try {
            // parse params from json payload
            DatacenterDeletionParams params =
                    gson.fromJson(payload, new TypeToken<DatacenterDeletionParams>() {}.getType());
            // do some modify to params(optional)
            List<WithTaskDeleteDatacenter> result = api.deleteDatacenter(params);
    ...
    public void getDatacenters(String payload) {
        try {
            // parse params from json payload
            GetDatacentersRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetDatacentersRequestBody>() {}.getType());
            // do some modify to params(optional)
            List<Datacenter> result = api.getDatacenters(params);
    ...
    public void getDatacentersConnection(String payload) {
        try {
            // parse params from json payload
            GetDatacentersConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetDatacentersConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
            DatacenterConnection result = api.getDatacentersConnection(params);
    ...
    public void updateDatacenter(String payload) {
        try {
            // parse params from json payload
            DatacenterUpdationParams params =
                    gson.fromJson(payload, new TypeToken<DatacenterUpdationParams>() {}.getType());
            // do some modify to params(optional)
            List<WithTaskDatacenter> result = api.updateDatacenter(params);
