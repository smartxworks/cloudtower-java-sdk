...
public class ITPmemDimm extends ITBase {
    ...
    public void getPmemDimms(String payload) {
        try {
            ...
            GetPmemDimmsRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetPmemDimmsRequestBody>() {}.getType());
    ...
    public void getPmemDimmsConnection(String payload) {
        try {
            // parse params from json payload
            GetPmemDimmsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetPmemDimmsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
