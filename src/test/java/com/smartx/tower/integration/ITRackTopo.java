...
public class ITRackTopo extends ITBase {
    ...
    public void createRackTopo(String payload) {
        try {
            ...
            List<RackTopoCreationParams> params =
                    gson.fromJson(
                            payload, new TypeToken<List<RackTopoCreationParams>>() {}.getType());
    ...
    public void deleteRackTopo(String payload) {
        try {
            // parse params from json payload
            RackTopoDeletionParams params =
                    gson.fromJson(payload, new TypeToken<RackTopoDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getRackTopoes(String payload) {
        try {
            // parse params from json payload
            GetRackTopoesRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetRackTopoesRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getRackTopoesConnection(String payload) {
        try {
            // parse params from json payload
            GetRackTopoesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetRackTopoesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateRackTopo(String payload) {
        try {
            // parse params from json payload
            RackTopoUpdationParams params =
                    gson.fromJson(payload, new TypeToken<RackTopoUpdationParams>() {}.getType());
            // do some modify to params(optional)
