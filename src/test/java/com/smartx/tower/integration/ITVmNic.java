...
public class ITVmNic extends ITBase {
    ...
    public void getVmNics(String payload) {
        try {
            ...
            GetVmNicsRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetVmNicsRequestBody>() {}.getType());
    ...
    public void getVmNicsConnection(String payload) {
        try {
            // parse params from json payload
            GetVmNicsConnectionRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetVmNicsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
