...
public class ITOrganization extends ITBase {
    ...
    public void createOrganization(String payload) {
        try {
            ...
            List<OrganizationCreationParams> params =
                    gson.fromJson(
                            payload,
                            new TypeToken<List<OrganizationCreationParams>>() {}.getType());
    ...
    public void deleteOrganization(String payload) {
        try {
            // parse params from json payload
            OrganizationDeletionParams params =
                    gson.fromJson(
                            payload, new TypeToken<OrganizationDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getOrganizations(String payload) {
        try {
            // parse params from json payload
            GetOrganizationsRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetOrganizationsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getOrganizationsConnection(String payload) {
        try {
            // parse params from json payload
            GetOrganizationsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetOrganizationsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateOrganization(String payload) {
        try {
            // parse params from json payload
            OrganizationUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<OrganizationUpdationParams>() {}.getType());
            // do some modify to params(optional)
