...
public class ITApplication extends ITBase {
    ...
    public void getApplications(String payload) {
        try {
            ...
            GetApplicationsRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetApplicationsRequestBody>() {}.getType());
    ...
    public void getApplicationsConnection(String payload) {
        try {
            // parse params from json payload
            GetApplicationsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetApplicationsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
