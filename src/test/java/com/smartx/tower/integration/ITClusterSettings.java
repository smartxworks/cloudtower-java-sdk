...
public class ITClusterSettings extends ITBase {
    ...
    @DataProvider(name = "clusterSettingsPayload")
    ...
    @Test(dataProvider = "clusterSettingsPayload")
    public void getClusterSettingses(String payload) {
        try {
            // parse params from json payload
            GetClusterSettingsesRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetClusterSettingsesRequestBody>() {}.getType());
    ...
    public void getClusterSettingsesConnection(String payload) {
        try {
            // parse params from json payload
            GetClusterSettingsesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    GetClusterSettingsesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
