...
public class ITIscsiTarget extends ITBase {
    ...
    @Test()
    public void createAndUpdateAndDeleteIscsiTarget()
            throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
                    NoSuchMethodException, SecurityException {
        try {
            // parse params from json payload
            List<IscsiTargetCreationParams> createParams =
                    new ArrayList<IscsiTargetCreationParams>();
            createParams.add(
            ...
            List<WithTaskDeleteIscsiTarget> deleteResult =
                    api.deleteIscsiTarget(
    ...
    public void getIscsiTargets(String payload) {
        try {
            // parse params from json payload
            GetIscsiTargetsRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetIscsiTargetsRequestBody>() {}.getType());
    ...
    public void getIscsiTargetsConnection(String payload) {
        try {
            // parse params from json payload
            GetIscsiTargetsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetIscsiTargetsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
