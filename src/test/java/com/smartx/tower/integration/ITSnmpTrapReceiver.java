...
public class ITSnmpTrapReceiver extends ITBase {
    ...
    public void createSnmpTrapReceiver(String payload) {
        try {
            ...
            List<SnmpTrapReceiverCreationParams> params =
                    gson.fromJson(
                            payload,
                            new TypeToken<List<SnmpTrapReceiverCreationParams>>() {}.getType());
    ...
    public void deleteSnmpTrapReceiver(String payload) {
        try {
            // parse params from json payload
            SnmpTrapReceiverDeletionParams params =
                    gson.fromJson(
                            payload, new TypeToken<SnmpTrapReceiverDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getSnmpTrapReceivers(String payload) {
        try {
            // parse params from json payload
            GetSnmpTrapReceiversRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetSnmpTrapReceiversRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getSnmpTrapReceiversConnection(String payload) {
        try {
            // parse params from json payload
            GetSnmpTrapReceiversConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    GetSnmpTrapReceiversConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateSnmpTrapReceiver(String payload) {
        try {
            // parse params from json payload
            SnmpTrapReceiverUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<SnmpTrapReceiverUpdationParams>() {}.getType());
            // do some modify to params(optional)
