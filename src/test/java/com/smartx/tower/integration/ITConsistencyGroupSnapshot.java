...
public class ITConsistencyGroupSnapshot extends ITBase {
    ...
    public void createConsistencyGroupSnapshot(String payload) {
        try {
            ...
            List<ConsistencyGroupSnapshotCreationParams> params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    List<ConsistencyGroupSnapshotCreationParams>>() {}.getType());
            // do some modify to params(optional)
            List<WithTaskConsistencyGroupSnapshot> result =
                    api.createConsistencyGroupSnapshot(params);
    ...
    public void deleteConsistencyGroupSnapshot(String payload) {
        try {
            // parse params from json payload
            ConsistencyGroupSnapshotDeletionParams params =
                    gson.fromJson(
                            payload,
                            new TypeToken<ConsistencyGroupSnapshotDeletionParams>() {}.getType());
            // do some modify to params(optional)
            List<WithTaskDeleteConsistencyGroupSnapshot> result =
                    api.deleteConsistencyGroupSnapshot(params);
    ...
    public void getConsistencyGroupSnapshots(String payload) {
        try {
            // parse params from json payload
            GetConsistencyGroupSnapshotsRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetConsistencyGroupSnapshotsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getConsistencyGroupSnapshotsConnection(String payload) {
        try {
            // parse params from json payload
            GetConsistencyGroupSnapshotsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    GetConsistencyGroupSnapshotsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
            ConsistencyGroupSnapshotConnection result =
                    api.getConsistencyGroupSnapshotsConnection(params);
            assertThat(result)
                    .as("check result of getConsistencyGroupSnapshotsConnection")
                    .isNotNull();
        } catch (ApiException e) {
            LOGGER.error(e.getResponseBody());
            LOGGER.error(e.getCode());
    ...
    public void updateConsistencyGroupSnapshot(String payload) {
        try {
            // parse params from json payload
            ConsistencyGroupSnapshotUpdationParams params =
                    gson.fromJson(
                            payload,
                            new TypeToken<ConsistencyGroupSnapshotUpdationParams>() {}.getType());
            // do some modify to params(optional)
            List<WithTaskConsistencyGroupSnapshot> result =
                    api.updateConsistencyGroupSnapshot(params);
