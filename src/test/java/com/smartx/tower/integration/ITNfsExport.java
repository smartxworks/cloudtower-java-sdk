...
public class ITNfsExport extends ITBase {
    ...
    public void createNfsExport(String payload) {
        try {
            ...
            List<NfsExportCreationParams> params =
                    gson.fromJson(
                            payload, new TypeToken<List<NfsExportCreationParams>>() {}.getType());
    ...
    public void deleteNfsExport(String payload) {
        try {
            // parse params from json payload
            NfsExportDeletionParams params =
                    gson.fromJson(payload, new TypeToken<NfsExportDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getNfsExports(String payload) {
        try {
            // parse params from json payload
            GetNfsExportsRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetNfsExportsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getNfsExportsConnection(String payload) {
        try {
            // parse params from json payload
            GetNfsExportsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetNfsExportsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateNfsExport(String payload) {
        try {
            // parse params from json payload
            NfsExportUpdationParams params =
                    gson.fromJson(payload, new TypeToken<NfsExportUpdationParams>() {}.getType());
            // do some modify to params(optional)
