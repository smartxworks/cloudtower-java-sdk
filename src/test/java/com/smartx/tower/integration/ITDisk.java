...
public class ITDisk extends ITBase {
    ...
    @Test(dataProvider = "diskPayload")
    public void getDisks(String payload) {
        try {
            // parse params from json payload
            GetDisksRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetDisksRequestBody>() {}.getType());
    ...
    public void getDisksConnection(String payload) {
        try {
            // parse params from json payload
            GetDisksConnectionRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetDisksConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void mountDisk(String payload) {
        try {
            // parse params from json payload
            DiskMountParams params =
                    gson.fromJson(payload, new TypeToken<DiskMountParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void unmountDisk(String payload) {
        try {
            // parse params from json payload
            DiskUnmountParams params =
                    gson.fromJson(payload, new TypeToken<DiskUnmountParams>() {}.getType());
            // do some modify to params(optional)
