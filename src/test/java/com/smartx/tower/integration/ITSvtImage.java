...
public class ITSvtImage extends ITBase {
    ...
    public void getSvtImages(String payload) {
        try {
            ...
            GetSvtImagesRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetSvtImagesRequestBody>() {}.getType());
    ...
    public void getSvtImagesConnection(String payload) {
        try {
            // parse params from json payload
            GetSvtImagesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetSvtImagesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
