...
public class ITNfsInode extends ITBase {
    ...
    @DataProvider(name = "nfsInodePayload")
    ...
    @Test(dataProvider = "nfsInodePayload")
    public void getNfsInodes(String payload) {
        try {
            // parse params from json payload
            GetNfsInodesRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetNfsInodesRequestBody>() {}.getType());
    ...
    public void getNfsInodesConnection(String payload) {
        try {
            // parse params from json payload
            GetNfsInodesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetNfsInodesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
