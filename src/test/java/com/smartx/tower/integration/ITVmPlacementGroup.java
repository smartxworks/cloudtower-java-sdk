...
public class ITVmPlacementGroup extends ITBase {
    ...
    public void createAndDeleteVmPlacementGroup(String payload)
        ...
        try {
            ...
            params.add(
                    new VmPlacementGroupCreationParams()
                            .clusterId(cluster.getId())
                            .name("tower-sdk-test-vm-placement-group" + System.currentTimeMillis())
                            .vmVmPolicy(VmVmPolicy.PREFER_SAME)
                            .vmVmPolicyEnabled(true)
                            .enabled(true)
                            .vmHostPreferPolicy(false)
                            .vmHostMustEnabled(false)
                            .vmHostMustPolicy(false)
                            .vmHostPreferEnabled(false));
            ...
            waitForTaskSucceed(
                    api.deleteVmPlacementGroup(
                                    new VmPlacementGroupDeletionParams()
                                            .where(
                                                    new VmPlacementGroupWhereInput()
                                                            .id(vmPlacementGroup.getId())))
                            .get(0)
                            .getTaskId());
    ...
    public void getVmPlacementGroups(String payload) {
        try {
            // parse params from json payload
            GetVmPlacementGroupsRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetVmPlacementGroupsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getVmPlacementGroupsConnection(String payload) {
        try {
            // parse params from json payload
            GetVmPlacementGroupsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    GetVmPlacementGroupsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void createVmPlacementGroup()
            throws InterruptedException, ApiException, IllegalAccessException,
    ...
    public void deleteVmPlacementGroup()
            throws InterruptedException, ApiException, IllegalAccessException,
                    IllegalArgumentException, InvocationTargetException, NoSuchMethodException,
                    SecurityException {
        waitForResourceAsyncStatus(
                new GetVmPlacementGroupsRequestBody()
                        .where(new VmPlacementGroupWhereInput().id(placementGroup.getId())),
                api,
                "getVmPlacementGroups",
                (new TypeToken<List<VmCreationParams>>() {}.getClass()),
                GetVmPlacementGroupsRequestBody.class);
        waitForTaskSucceed(
                api.deleteVmPlacementGroup(
                                new VmPlacementGroupDeletionParams()
                                        .where(
                                                new VmPlacementGroupWhereInput()
                                                        .id(placementGroup.getId())))
                        .get(0)
                        .getTaskId());
        placementGroup = null;
    }
    ...
    @Test(
            dataProvider = "vmPlacementGroupPayload",
            groups = {"need_vm_placement_group"})
    public void updateVmPlacementGroup(String payload) {
        try {
            // parse params from json payload
            VmPlacementGroupUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<VmPlacementGroupUpdationParams>() {}.getType());
            params.where(new VmPlacementGroupWhereInput().id(placementGroup.getId()))
                    .data(
                            new VmPlacementGroupUpdationParamsData()
                                    .description("vm_placement_group_api_test"));
            // do some modify to params(optional)
