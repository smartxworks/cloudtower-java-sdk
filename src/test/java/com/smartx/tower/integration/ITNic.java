...
public class ITNic extends ITBase {
    ...
    public void getNics(String payload) {
        try {
            ...
            GetNicsRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetNicsRequestBody>() {}.getType());
    ...
    public void getNicsConnection(String payload) {
        try {
            // parse params from json payload
            GetNicsConnectionRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetNicsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateNic(String payload) {
        try {
            // parse params from json payload
            NicUpdationParams params =
                    gson.fromJson(payload, new TypeToken<NicUpdationParams>() {}.getType());
            // do some modify to params(optional)
