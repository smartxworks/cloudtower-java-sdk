...
public class ITZoneTopo extends ITBase {
    ...
    public void getZoneTopoes(String payload) {
        try {
            ...
            GetZoneTopoesRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetZoneTopoesRequestBody>() {}.getType());
    ...
    public void getZoneTopoesConnection(String payload) {
        try {
            // parse params from json payload
            GetZoneTopoesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetZoneTopoesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
