...
public class ITEntityFilter extends ITBase {
    ...
    public void createEntityFilter(String payload) {
        try {
            ...
            List<EntityFilterCreationParams> params =
                    gson.fromJson(
                            payload,
                            new TypeToken<List<EntityFilterCreationParams>>() {}.getType());
    ...
    public void deleteEntityFilter(String payload) {
        try {
            // parse params from json payload
            EntityFilterDeletionParams params =
                    gson.fromJson(
                            payload, new TypeToken<EntityFilterDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getEntityFilters(String payload) {
        try {
            // parse params from json payload
            GetEntityFiltersRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetEntityFiltersRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getEntityFiltersConnection(String payload) {
        try {
            // parse params from json payload
            GetEntityFiltersConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetEntityFiltersConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateEntityFilter(String payload) {
        try {
            // parse params from json payload
            EntityFilterUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<EntityFilterUpdationParams>() {}.getType());
            // do some modify to params(optional)
