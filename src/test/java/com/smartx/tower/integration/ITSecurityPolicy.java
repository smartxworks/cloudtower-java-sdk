...
public class ITSecurityPolicy extends ITBase {
    ...
    @DataProvider(name = "securityPolicyPayload")
    ...
    @Test(dataProvider = "securityPolicyPayload")
    public void getSecurityPolicies(String payload) {
        try {
            // parse params from json payload
            GetSecurityPoliciesRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetSecurityPoliciesRequestBody>() {}.getType());
    ...
    public void getSecurityPoliciesConnection(String payload) {
        try {
            // parse params from json payload
            GetSecurityPoliciesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetSecurityPoliciesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
