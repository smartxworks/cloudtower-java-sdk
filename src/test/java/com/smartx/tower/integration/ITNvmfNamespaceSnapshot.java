...
public class ITNvmfNamespaceSnapshot extends ITBase {
    ...
    public void createNvmfNamespaceSnapshot(String payload) {
        try {
            ...
            List<NvmfNamespaceSnapshotCreationParams> params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    List<NvmfNamespaceSnapshotCreationParams>>() {}.getType());
    ...
    public void deleteNvmfNamespaceSnapshot(String payload) {
        try {
            // parse params from json payload
            NvmfNamespaceSnapshotDeletionParams params =
                    gson.fromJson(
                            payload,
                            new TypeToken<NvmfNamespaceSnapshotDeletionParams>() {}.getType());
            // do some modify to params(optional)
            List<WithTaskDeleteNvmfNamespaceSnapshot> result =
                    api.deleteNvmfNamespaceSnapshot(params);
    ...
    public void getNvmfNamespaceSnapshots(String payload) {
        try {
            // parse params from json payload
            GetNvmfNamespaceSnapshotsRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetNvmfNamespaceSnapshotsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getNvmfNamespaceSnapshotsConnection(String payload) {
        try {
            // parse params from json payload
            GetNvmfNamespaceSnapshotsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    GetNvmfNamespaceSnapshotsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
            NvmfNamespaceSnapshotConnection result =
                    api.getNvmfNamespaceSnapshotsConnection(params);
            assertThat(result)
                    .as("check result of getNvmfNamespaceSnapshotsConnection")
                    .isNotNull();
        } catch (ApiException e) {
            LOGGER.error(e.getResponseBody());
            LOGGER.error(e.getCode());
