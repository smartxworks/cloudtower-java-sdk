...
public class ITVlan extends ITBase {
    ...
    public void createVmVlan(String payload) {
        try {
            ...
            List<VmVlanCreationParams> params =
                    gson.fromJson(
                            payload, new TypeToken<List<VmVlanCreationParams>>() {}.getType());
    ...
    public void deleteVlan(String payload) {
        try {
            // parse params from json payload
            VlanDeletionParams params =
                    gson.fromJson(payload, new TypeToken<VlanDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getVlans(String payload) {
        try {
            // parse params from json payload
            GetVlansRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetVlansRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getVlansConnection(String payload) {
        try {
            // parse params from json payload
            GetVlansConnectionRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetVlansConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateManagementVlan(String payload) {
        try {
            // parse params from json payload
            ManagementVlanUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<ManagementVlanUpdationParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateMigrationVlan(String payload) {
        try {
            // parse params from json payload
            MigrationVlanUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<MigrationVlanUpdationParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateVlan(String payload) {
        try {
            // parse params from json payload
            VmVlanUpdationParams params =
                    gson.fromJson(payload, new TypeToken<VmVlanUpdationParams>() {}.getType());
            // do some modify to params(optional)
