...
public class ITClusterImage extends ITBase {
    ...
    public void getClusterImages(String payload) {
        try {
            ...
            GetClusterImagesRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetClusterImagesRequestBody>() {}.getType());
    ...
    public void getClusterImagesConnection(String payload) {
        try {
            // parse params from json payload
            GetClusterImagesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetClusterImagesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
