...
public class ITUserRoleNext extends ITBase {
    ...
    public void createRole(String payload) {
        try {
            ...
            List<RoleCreationParams> params =
                    gson.fromJson(payload, new TypeToken<List<RoleCreationParams>>() {}.getType());
    ...
    public void deleteRole(String payload) {
        try {
            // parse params from json payload
            RoleDeletionParams params =
                    gson.fromJson(payload, new TypeToken<RoleDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getUserRoleNexts(String payload) {
        try {
            // parse params from json payload
            GetUserRoleNextsRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetUserRoleNextsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getUserRoleNextsConnection(String payload) {
        try {
            // parse params from json payload
            GetUserRoleNextsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetUserRoleNextsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateRole(String payload) {
        try {
            // parse params from json payload
            RoleUpdationParams params =
                    gson.fromJson(payload, new TypeToken<RoleUpdationParams>() {}.getType());
            // do some modify to params(optional)
