...
public class ITGraph extends ITBase {
    ...
    public void createGraph(String payload) {
        try {
            ...
            List<GraphCreationParams> params =
                    gson.fromJson(payload, new TypeToken<List<GraphCreationParams>>() {}.getType());
    ...
    public void deleteGraph(String payload) {
        try {
            // parse params from json payload
            GraphDeletionParams params =
                    gson.fromJson(payload, new TypeToken<GraphDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getGraphs(String payload) {
        try {
            // parse params from json payload
            GetGraphsRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetGraphsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getGraphsConnection(String payload) {
        try {
            // parse params from json payload
            GetGraphsConnectionRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetGraphsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateGraph(String payload) {
        try {
            // parse params from json payload
            GraphUpdationParams params =
                    gson.fromJson(payload, new TypeToken<GraphUpdationParams>() {}.getType());
            // do some modify to params(optional)
