...
public class ITVcenterAccount extends ITBase {
    ...
    @DataProvider(name = "vcenterAccountPayload")
    ...
    @Test(dataProvider = "vcenterAccountPayload")
    public void getVcenterAccounts(String payload) {
        try {
            // parse params from json payload
            GetVcenterAccountsRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetVcenterAccountsRequestBody>() {}.getType());
    ...
    public void getVcenterAccountsConnection(String payload) {
        try {
            // parse params from json payload
            GetVcenterAccountsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetVcenterAccountsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
