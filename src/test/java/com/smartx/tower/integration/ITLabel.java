...
public class ITLabel extends ITBase {
    ...
    public void addLabelsToResources(String payload) {
        try {
            ...
            AddLabelsToResourcesParams params =
                    gson.fromJson(
                            payload, new TypeToken<AddLabelsToResourcesParams>() {}.getType());
    ...
    public void createLabel(String payload) {
        try {
            // parse params from json payload
            List<LabelCreationParams> params =
                    gson.fromJson(payload, new TypeToken<List<LabelCreationParams>>() {}.getType());
            // do some modify to params(optional)
    ...
    public void deleteLabel(String payload) {
        try {
            // parse params from json payload
            LabelDeletionParams params =
                    gson.fromJson(payload, new TypeToken<LabelDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getLabels(String payload) {
        try {
            // parse params from json payload
            GetLabelsRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetLabelsRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getLabelsConnection(String payload) {
        try {
            // parse params from json payload
            GetLabelsConnectionRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetLabelsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateLabel(String payload) {
        try {
            // parse params from json payload
            LabelUpdationParams params =
                    gson.fromJson(payload, new TypeToken<LabelUpdationParams>() {}.getType());
            // do some modify to params(optional)
