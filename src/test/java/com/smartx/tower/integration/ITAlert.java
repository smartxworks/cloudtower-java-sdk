...
public class ITAlert extends ITBase {
    ...
    public void getAlerts(String payload) {
        try {
            ...
            GetAlertsRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetAlertsRequestBody>() {}.getType());
    ...
    public void getAlertsConnection(String payload) {
        try {
            // parse params from json payload
            GetAlertsConnectionRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetAlertsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void resolveAlert(String payload) {
        try {
            ...
            // parse params from json payload
            ResolveAlertParams params =
                    gson.fromJson(payload, new TypeToken<ResolveAlertParams>() {}.getType());
