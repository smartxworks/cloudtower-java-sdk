...
public class ITGlobalAlertRule extends ITBase {
    ...
    public void getGlobalAlertRules(String payload) {
        try {
            ...
            GetGlobalAlertRulesRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetGlobalAlertRulesRequestBody>() {}.getType());
    ...
    public void getGlobalAlertRulesConnection(String payload) {
        try {
            // parse params from json payload
            GetGlobalAlertRulesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetGlobalAlertRulesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateCustomizeAlertRule(String payload) {
        try {
            // parse params from json payload
            CustomizeAlertRuleUpdationParams params =
                    gson.fromJson(
                            payload,
                            new TypeToken<CustomizeAlertRuleUpdationParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateGlobalAlertRule(String payload) {
        try {
            // parse params from json payload
            GlobalAlertRuleUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<GlobalAlertRuleUpdationParams>() {}.getType());
            // do some modify to params(optional)
