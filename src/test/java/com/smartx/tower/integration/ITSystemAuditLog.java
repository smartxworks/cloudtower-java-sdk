...
public class ITSystemAuditLog extends ITBase {
    ...
    public void getSystemAuditLogs(String payload) {
        try {
            ...
            GetSystemAuditLogsRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetSystemAuditLogsRequestBody>() {}.getType());
    ...
    public void getSystemAuditLogsConnection(String payload) {
        try {
            // parse params from json payload
            GetSystemAuditLogsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetSystemAuditLogsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
