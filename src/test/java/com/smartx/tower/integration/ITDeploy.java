...
public class ITDeploy extends ITBase {
    ...
    public void getDeploys(String payload) {
        try {
            ...
            GetDeploysRequestBody params =
                    gson.fromJson(payload, new TypeToken<GetDeploysRequestBody>() {}.getType());
    ...
    public void getDeploysConnection(String payload) {
        try {
            // parse params from json payload
            GetDeploysConnectionRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetDeploysConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
