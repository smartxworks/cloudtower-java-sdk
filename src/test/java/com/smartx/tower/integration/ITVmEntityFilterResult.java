...
public class ITVmEntityFilterResult extends ITBase {
    ...
    public void getVmEntityFilterResults(String payload) {
        try {
            ...
            GetVmEntityFilterResultsRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetVmEntityFilterResultsRequestBody>() {}.getType());
    ...
    public void getVmEntityFilterResultsConnection(String payload) {
        try {
            // parse params from json payload
            GetVmEntityFilterResultsConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    GetVmEntityFilterResultsConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
