...
public class ITEverouteLicense extends ITBase {
    ...
    @DataProvider(name = "everouteLicensePayload")
    ...
    @Test(dataProvider = "everouteLicensePayload")
    public void getEverouteLicenses(String payload) {
        try {
            // parse params from json payload
            GetEverouteLicensesRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetEverouteLicensesRequestBody>() {}.getType());
    ...
    public void getEverouteLicensesConnection(String payload) {
        try {
            // parse params from json payload
            GetEverouteLicensesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetEverouteLicensesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
