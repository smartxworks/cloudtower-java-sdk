...
public class ITClusterTopo extends ITBase {
    ...
    public void getClusterTopoes(String payload) {
        try {
            ...
            GetClusterTopoesRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetClusterTopoesRequestBody>() {}.getType());
    ...
    public void getClusterTopoesConnection(String payload) {
        try {
            // parse params from json payload
            GetClusterTopoesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetClusterTopoesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
