...
public class ITNvmfNamespace extends ITBase {
    ...
    public void cloneNvmfNamespaceFromSnapshot(String payload) {
        try {
            ...
            List<NvmfNamespaceCloneParams> params =
                    gson.fromJson(
                            payload, new TypeToken<List<NvmfNamespaceCloneParams>>() {}.getType());
    ...
    public void createNvmfNamespace(String payload) {
        try {
            // parse params from json payload
            List<NvmfNamespaceCreationParams> params =
                    gson.fromJson(
                            payload,
                            new TypeToken<List<NvmfNamespaceCreationParams>>() {}.getType());
            // do some modify to params(optional)
    ...
    public void deleteNvmfNamespace(String payload) {
        try {
            // parse params from json payload
            NvmfNamespaceDeletionParams params =
                    gson.fromJson(
                            payload, new TypeToken<NvmfNamespaceDeletionParams>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getNvmfNamespaces(String payload) {
        try {
            // parse params from json payload
            GetNvmfNamespacesRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetNvmfNamespacesRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void getNvmfNamespacesConnection(String payload) {
        try {
            // parse params from json payload
            GetNvmfNamespacesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetNvmfNamespacesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
    ...
    public void rollbackNvmfNamespaceFromSnapshot(String payload) {
        try {
            // parse params from json payload
            List<NvmfNamespaceRollbackParams> params =
                    gson.fromJson(
                            payload,
                            new TypeToken<List<NvmfNamespaceRollbackParams>>() {}.getType());
            // do some modify to params(optional)
    ...
    public void updateNvmfNamespace(String payload) {
        try {
            // parse params from json payload
            NvmfNamespaceUpdationParams params =
                    gson.fromJson(
                            payload, new TypeToken<NvmfNamespaceUpdationParams>() {}.getType());
            // do some modify to params(optional)
