...
public class ITElfStoragePolicy extends ITBase {
    ...
    @DataProvider(name = "elfStoragePolicyPayload")
    ...
    @Test(dataProvider = "elfStoragePolicyPayload")
    public void getElfStoragePolicies(String payload) {
        try {
            // parse params from json payload
            GetElfStoragePoliciesRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetElfStoragePoliciesRequestBody>() {}.getType());
    ...
    public void getElfStoragePoliciesConnection(String payload) {
        try {
            // parse params from json payload
            GetElfStoragePoliciesConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<
                                    GetElfStoragePoliciesConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
