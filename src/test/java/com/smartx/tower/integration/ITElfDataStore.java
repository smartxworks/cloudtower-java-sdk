...
public class ITElfDataStore extends ITBase {
    ...
    public void getElfDataStores(String payload) {
        try {
            ...
            GetElfDataStoresRequestBody params =
                    gson.fromJson(
                            payload, new TypeToken<GetElfDataStoresRequestBody>() {}.getType());
    ...
    public void getElfDataStoresConnection(String payload) {
        try {
            // parse params from json payload
            GetElfDataStoresConnectionRequestBody params =
                    gson.fromJson(
                            payload,
                            new TypeToken<GetElfDataStoresConnectionRequestBody>() {}.getType());
            // do some modify to params(optional)
